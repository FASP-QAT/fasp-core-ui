...
export interface Options {
	...
	*/
	...
	/**
	 Assign a callback function which will be called when mouse button down from a row in table.
	 This function taking one argument: row which is the row data which mouse out.
	 */
	onRowMouseDown?: Function;
	/**
	 Assign a callback function which will be called when contextmenu from a row in table.
	 This function taking one argument: row which is the row data which mouse out.
	 */
