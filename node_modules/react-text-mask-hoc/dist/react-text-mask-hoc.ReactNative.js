...
class TextInputAdapter extends React.Component {
  constructor(props) {
    super(props);
...
class TextAdapter extends React.PureComponent {
...
export { TextMask, TextInputAdapter, TextAdapter, TextMaskTransformer };
