...
const routes = [
  ...
  // { path: '/healthArea/listHealthArea/:message', component: HealthAreaList },
  { path: '/forecastProgram/listForecastProgram/:color/:message', name: i18n.t('static.breadcrum.list', { entityname: i18n.t('static.forecastProgram.forecastProgram') }), component: ForecastProgramList },
  ...
  { path: '/forecastMethod/editForecastMethod/:forecastMethodId', name: i18n.t('static.breadcrum.edit', { entityname: i18n.t('static.forecastMethod.forecastMethod') }), component: EditForecastMethod },

  { path: '/usagePeriod/addUsagePeriod', name: i18n.t('static.breadcrum.add', { entityname: i18n.t('static.usagePeriod.usagePeriod') }), component: AddUsagePeriod },
  // { path: '/healthArea/listHealthArea/:message', component: HealthAreaList },
  ...
  { path: '/usagePeriod/editUsagePeriod/:usagePeriodId', name: i18n.t('static.breadcrum.edit', { entityname: i18n.t('static.usagePeriod.usagePeriod') }), component: EditUsagePeriod },

  { path: '/scaleUpType/addscaleUpType', name: i18n.t('static.breadcrum.add', { entityname: i18n.t('static.scaleUpType.scaleUpType') }), component: AddScaleUpType },
  // { path: '/scaleUpType/listScaleUpType/:message', component: ScaleUpTypeList },
  { path: '/scaleUpType/listscaleUpType/:color/:message', name: i18n.t('static.breadcrum.list', { entityname: i18n.t('static.scaleUpType.scaleUpType') }), component: ScaleUpTypeList },
