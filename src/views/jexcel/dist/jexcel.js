...
var jexcel = (function(el, options) {
    ...
    obj.createTable = function() {
        ...
        paginationUpdateContainer.classList.add('select_sorting');
        paginationUpdateContainer.classList.add('order-1');
        paginationUpdateContainer.classList.add('col-md-1');
        ...
        tempCol.appendChild(SrNo);
        tempCol.classList.add('jexcel_selectall');
        tempCol.classList.add('text-center');
        ...
        obj.pagination.classList.add('row');
