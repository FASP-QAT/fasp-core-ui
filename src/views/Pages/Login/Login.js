                            ...
                            <Form onSubmit={handleSubmit} noValidate name="loginForm">
                              ...
                              <Row>
                                <Col xs="6">
                                  ...
                                  <Button type="submit" color="primary" className="px-4 Login-btn" onClick={() => this.touchAll(setTouched, errors)} >{i18n.t('static.login.login')}</Button>
                                </Col>
                                <Col xs="6" className="text-right">
                                  <Button color="link" className="px-0 Login-fpwd">{i18n.t('static.login.forgotpassword')}?</Button>
                                </Col>
                              </Row>
                            </Form>
                          )} />
