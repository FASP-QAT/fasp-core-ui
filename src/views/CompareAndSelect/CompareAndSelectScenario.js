        ...
        if (this.state.planningUnitId > 0 && this.state.regionId != "") {
            ...
            this.setState({
                ...
                var options = {
                    ...
                    editable: this.state.datasetId != "" && AuthenticationService.checkUserACL([this.state.datasetId.toString()], 'ROLE_BF_COMPARE_AND_SELECT') ? true : false
                };
                                                        ...
                                                        <div className="controls">
                                                            <InputGroup>
                                                                <Input
                                                                    ...
                                                                    readOnly={this.state.datasetId != "" && AuthenticationService.checkUserACL([this.state.datasetId.toString()], 'ROLE_BF_COMPARE_AND_SELECT') ? false : true}
                                                                    bsSize="sm"
                                                                >
                                                                </Input>
                                                            </InputGroup>
