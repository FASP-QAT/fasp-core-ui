                ...
                <Modal isOpen={this.state.showGuidance}
                    ...
                    <div>
                        <ModalBody>
                            ...
                            <p>
                                <p style={{ fontSize: '13px' }}><span className="UnderLineText">{i18n.t('static.listTree.purpose')} :</span> {i18n.t('static.forecastOutput.enableUserView')}</p>
                            </p>
                            <p style={{ fontSize: '13px' }}>
                                <p style={{ fontSize: '13px' }}><span className="UnderLineText">{i18n.t('static.listTree.useThisScreen')} :</span></p>
                                <p>
                                    <ul>
                                        <li>{i18n.t('static.forecastOutput.onlySelectForecast')}'<a href='/#/report/compareAndSelectScenario' target="_blank" style={{ textDecoration: 'underline' }}>{i18n.t('static.dashboard.compareAndSelect')}</a>' {i18n.t('static.forecastOutput.totalForecastAcrossProduct')} '<a href='/#/forecastReport/forecastSummary' target="_blank" style={{ textDecoration: 'underline' }}>{i18n.t('static.commitTree.forecastSummary')}</a>' {i18n.t('static.forecastOutput.screen')}.</li>
                                        <li>{i18n.t('static.forecastOutput.the')} <b>{i18n.t('static.report.dateRange')}</b> {i18n.t('static.forecastOutput.willBeUseToDetermine')} </li>
                                        <li>{i18n.t('static.forecastOutput.useParameter')} </li>
                                        <li><b>{i18n.t('static.equivalancyUnit.equivalancyUnits')} </b>{i18n.t('static.forecastOutput.allowUserToAggregate')} <a href='/#/equivalancyUnit/listEquivalancyUnit' target="_blank" style={{ textDecoration: 'underline' }}>{i18n.t('static.equivalancyUnit.equivalancyUnits')}</a> {i18n.t('static.forecastOutput.screen')}.</li>
                                        <li>{i18n.t('static.forecastOutput.xAxisAggrigateByYear')}</li>
                                        <li>{i18n.t('static.forecastOutput.forGraphView')}
                                            <ul style={{ listStyle: 'none' }}>
                                                <li>{i18n.t('static.forecastOutput.filterTopToSelectProduct')} </li>
                                                <li>{i18n.t('static.forecastOutput.productInLegendOfGraph')} </li>
                                                <li>{i18n.t('static.forecastOutput.uncheckDisplay')}</li>
                                            </ul>
                                        </li>
                                    </ul>
                                </p>
