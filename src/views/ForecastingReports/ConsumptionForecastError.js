                        ...
                        this.setState({
                            ...
                            if (viewById == 1) {//planningUnitId
                                ...
                                for (let k = 0; k < filteredPlanningUnitList.length; k++) {
                                    ...
                                    if (consumptionExtrapolationId != null) {
                                        ...
                                        if (consumptionExtrapolationObj.length > 0) {
                                            ...
                                            //filter based on region
                                            let actualConsumptionList3 = [];
                                            for (let j = 0; j < regionIds.length; k++) {
                                ...
                                let forecast = monthArrayList.map(item => {
                                    var cd = tempConsumptionList.filter(c => moment(c.consumptionDate).format("YYYY-MM-DD") == moment(item).format("YYYY-MM-DD") && !c.actualFlag && regionIdArr.includes(c.region.regionId));
                                    var sum = 0;
                                ...
                                let difference = monthArrayList.map(item => {
                                    ...
                                    var sum = 0;
                                    cd.map(c => { sum += c.consumptionQty });
                                    var cd1 = tempConsumptionList.filter(c => moment(c.consumptionDate).format("YYYY-MM-DD") == moment(item).format("YYYY-MM-DD") && c.actualFlag && regionIdArr.includes(c.region.regionId));
                                    var sum1 = 0;
                                ...
                                this.setState({
                                    ...
                                    consumptionData: tempConsumptionList,
            ...
            this.setState({
                ...
                if (versionId == -1) {
                    ...
                    if (versionId.includes('Local')) {
                        ...
                        let consumptionForecastTrueList = programData.planningUnitList.filter(c => c.consuptionForecast == true)
