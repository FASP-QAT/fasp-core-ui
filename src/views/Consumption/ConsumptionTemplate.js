...
class ConsumptionTemplate extends Component {
    constructor(props) {
        super(props);
        var dt = new Date();
    ...
    exportCSV(columns) {
        ...
        var csvRow = [];
        csvRow.push('"' + (i18n.t('Date Range') + ' : ' + this.makeText(this.state.rangeValue.from) + ' ~ ' + this.makeText(this.state.rangeValue.to)).replaceAll(' ', '%20') + '"')
        csvRow.push('')
        csvRow.push('"' + (i18n.t('static.program.program') + ' : ' + document.getElementById("programId").selectedOptions[0].text).replaceAll(' ', '%20') + '"')
        csvRow.push('')
        csvRow.push('"' + (i18n.t('Region').replaceAll(' ', '%20') + '  :  ' + document.getElementById("versionId").selectedOptions[0].text).replaceAll(' ', '%20') + '"')
        csvRow.push('')
        ...
        a.target = "_Blank"
        a.download = i18n.t('ConsumptionTemplate') + "-" + this.state.rangeValue.from.year + this.state.rangeValue.from.month + i18n.t('static.report.consumptionTo') + this.state.rangeValue.to.year + this.state.rangeValue.to.month + ".csv"
    ...
    exportPDF = (columns) => {
        ...
        let data = this.state.data.map(ele => ['Program', getLabelText(ele.planningUnit.label, this.state.lang), new moment('Consumption month').format('MMM YYYY'), this.formatter(ele.stockAdjustemntQty)]);
    ...
    buildJExcel() {
        ...
        var options = {
            ...
            columns: [
                ...
                {
                    title: i18n.t('Consumption Month'),
                    type: 'calendar', options: { format: JEXCEL_MONTH_PICKER_FORMAT, type: 'year-month-picker' },
                    readOnly: true
                },
                {
                    title: i18n.t('Acutal Consumption'),
                    type: 'numeric', mask: '[-]#,##',
                    readOnly: false
                },
                {
                    title: i18n.t('Number of Days Stocked Out'),
                    type: 'text',
                    readOnly: false
                },
                {
                    title: i18n.t('Reporting Rate (%)'),
                    type: 'text',
                    readOnly: false
                },
            ],
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                text: i18n.t('Actual Consumption'),
                sort: true,
                align: 'center',
                headerAlign: 'center',
                style: { width: '80px' },
            ...
            },
            {
                ...
                text: i18n.t('Number of Days Stcked Out'),
                sort: true,
                align: 'center',
                style: { width: '80px' },
                headerAlign: 'center'
                        ...
                        <div className="pl-0">
                            <div className="row">
                                <FormGroup className="col-md-3">
                                    <Label htmlFor="appendedInputButton">{i18n.t('Date Range')}<span className="stock-box-icon  fa fa-sort-desc ml-1"></span></Label>
                                ...
                                <FormGroup className="col-md-3">
                                    <Label htmlFor="appendedInputButton">{i18n.t('Region')}</Label>
                                    <div className="controls ">
                                        <InputGroup>
                                            <Input
                                                type="select"
                                            ...
                                            >
                                                <option value={this.state.versionId}>{i18n.t('North')}</option>
                                                {versionList}
                                            </Input>
