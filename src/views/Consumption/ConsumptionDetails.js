        ...
        if (cont == true) {
            ...
            if (puList.length > 0) {
                ...
                if (document.getElementById("addRowButtonId") != null) {
                    ...
                    if (AuthenticationService.checkUserACLBasedOnRoleId([programId.split("_")[0].toString()], 'ROLE_GUEST_USER') || (this.state.programQPLDetails.filter(c => c.id == this.state.programId))[0].readonly) {
                        document.getElementById("addRowButtonId").style.display = "none";
                    }
                }
                var db1;
                    ...
                    <CardFooter>
                        <FormGroup>
                            <FormGroup>
                                ...
                                &nbsp;
                                {this.refs.consumptionChild != undefined && <Button color="info" id="addRowButtonId" size="md" className="float-right mr-1" type="button" onClick={this.refs.consumptionChild.addRowInJexcel}>{i18n.t('static.common.addRow')}</Button>}&nbsp;
                            </FormGroup>
                        </FormGroup>
                    </CardFooter>
                </Card>
