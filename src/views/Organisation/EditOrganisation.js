...
const validationSchema = function (values) {
    return Yup.object().shape({
        ...
        organisationCode: Yup.string()
            .required('enter organisation code')
    })
}
...
export default class EditOrganisationComponent extends Component {
    ...
    //                                         </div>
    //                                         <div class="form-group">
    //                                             <label class="req col-md-2 col-xs-12 control-label">Organisation Code</label>
    //                                             <div class="col-md-6 col-xs-12">
    ...
    //                                         </div>
    //                                         <div class="form-group">
    //                                             <label class="req col-md-2 col-xs-12 control-label">Organisation Name</label>
    //                                             <div class="col-md-6 col-xs-12">
            ...
            <div className="animated fadeIn">
                <Row>
                    <Col sm={12} md={6} style={{ flexBasis: 'auto' }}>
                        <Card>
                            <CardHeader>
                                <i className="icon-note"></i><strong>Edit Organisation</strong>{' '}
                            </CardHeader>
                            <Formik
                                        ...
                                        setTouched
                                            ...
                                            <Form onSubmit={handleSubmit} noValidate name='organisationForm'>
                                                <CardBody>
                                                    ...
                                                    <FormGroup>
                                                        <Label htmlFor="realmId">{i18n.t('static.program.realm')}</Label>
                                                        <Input
                                                    ...
                                                    <FormGroup>
                                                        <Label htmlFor="realmCountryId">{i18n.t('static.program.realmcountry')}</Label>
                                                        <Select
                                                    ...
                                                    <FormGroup>
                                                        <Label htmlFor="organisationName">Organisation Name(English) </Label>
                                                        <Input
