...
export default class AddOrganisationComponent extends Component {
    ...
    //                                         <h3 class="panel-title">Add Organisation</h3>
    //                                     </div>
    ...
    //                                         </div>
    //                                         <div class="form-group">
    //                                             <label class="req col-md-2 col-xs-12 control-label">Organisation Name (Eng)</label>
    //                                             <div class="col-md-6 col-xs-12">
            ...
            <div className="animated fadeIn">
                <Row>
                    <Col sm={12} md={6} style={{ flexBasis: 'auto' }}>
                        <Card>
                            <CardHeader>
                                <i className="icon-note"></i><strong>Add Organisation</strong>{' '}
                            </CardHeader>
                            <Formik
