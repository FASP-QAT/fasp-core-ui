              ...
              <ModalBody>
                ...
                {this.state.showOnlyMaster == 1 && <div className="mt-2 mb-2">
                  ...
                  <ListGroup>
                    ...
                    <ListGroupItem className="list-group-item-help" tag="a" onClick={() => { this.showOnlyAddMasterForms(11) }} action><i className="icon-note icons helpclickicon mr-2"></i> {i18n.t('static.dashboard.realmcountry')} <i className="fa fa-angle-right helpclickicon mr-2 mt-1 float-right"></i></ListGroupItem>
                ...
                {this.state.showEditMaster == 1 && <div className="mt-2 mb-2">
                  ...
                  <ListGroup>
                    ...
                    <ListGroupItem className="list-group-item-help" tag="a" onClick={() => { this.showOnlyEditMasterForms(11) }} action><i className="icon-note icons helpclickicon mr-2"></i> {i18n.t('static.dashboard.realmcountry')} <i className="fa fa-angle-right helpclickicon mr-2 mt-1 float-right"></i></ListGroupItem>
