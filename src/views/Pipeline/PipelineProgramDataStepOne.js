                            ...
                            setTouched
                                ...
                                <Form className="needs-validation" onSubmit={handleSubmit} noValidate name='realmForm'>
                                    ...
                                    <FormGroup>
                                        ...
                                        <Button color="info" size="md" className="float-right mr-1" type="button" onClick={this.props.endProgramInfoStepOne}>Next <i className="fa fa-angle-double-right"></i></Button>
                                    </FormGroup>
