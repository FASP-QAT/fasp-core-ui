    ...
    savePlanningUnits() {
        ...
        for (var i = 0; i < json.length; i++) {
            ...
            var planningUnitJson = {
                ...
                programPlanningUnitId: map.get("4")
            }
                                        ...
                                        if (response.data.length > 0) {
                                            ...
                                            if (planningUnitList.length != 0) {
                                                for (var j = 0; j < planningUnitList.length; j++) {
                                                    data = [];
                                                    data[0] = planningUnitList[j].productCategoryId,
                                                        data[1] = planningUnitList[j].planningUnit.id;
                                                    data[2] = planningUnitList[j].reorderFrequencyInMonths;
                                                    data[3] = planningUnitList[j].minMonthsOfStock;
                                                    data[4] = planningUnitList[j].programPlanningUnitId
