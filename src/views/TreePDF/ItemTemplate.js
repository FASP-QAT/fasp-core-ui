  ...
  function render(doc, position, data) {
    ...
    if (result2) {
      if (itemConfig.payload.nodeType.id == 4 || itemConfig.payload.nodeType.id == 5) {
        ...
        doc.image(new Buffer(image.replace('data:image/png;base64,', ''), 'base64'), position.x + 165, position.y + 4, { fit: [14, 14] });
      } else {
        // blue image
    ...
    if (result1) {
      var position123 = (result2 == true) ? 150 : 165;
      if (itemConfig.payload.nodeType.id == 4 || itemConfig.payload.nodeType.id == 5) {
        // White image
    ...
    if (result) {
      var position123 = (result2 == true && result1 == true) ? 140 : result2 == true || result1 == true ? 150 : 165;
      if (itemConfig.payload.nodeType.id == 4 || itemConfig.payload.nodeType.id == 5) {
        // White image
