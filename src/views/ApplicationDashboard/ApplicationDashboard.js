                            ...
                            return (
                              <tr>
                                {localStorage.getItem("topLocalProgram") == "true" && <td scope="row">
                                  ...
                                  <i class="cui-cloud-download icons" style={{ color: d.isLatest ? "" : "#FF0000", cursor: "pointer" }} title="Download" onClick={() => this.redirectToCrudWindow("/program/downloadProgram/")}></i> &nbsp;
                                  <i class="cui-cloud-upload icons" style={{ color: d.isChanged ? "" : "#FF0000", cursor: "pointer" }} title="Upload" onClick={() => this.redirectToCrudWindow("/program/syncPage/")}></i> &nbsp;
