        ...
        <thead>
          <tr>
            ...
            {this.state.monthArray.map((item, count) => {
              return (<th className="supplyplanTdWidthForMonths">{item.date}</th>)
            })}
