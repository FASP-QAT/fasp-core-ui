...
class AuthenticationService {
    ...
    setRecordCount(count) {
        ...
        localStorage.setItem('sesCountryIdMulti', "");
        localStorage.setItem('sesProgramIdMulti', "");
