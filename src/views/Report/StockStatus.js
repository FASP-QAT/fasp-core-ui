...
class StockStatus extends Component {
  ...
  exportCSV() {
    ...
    csvRow.push(
      '"' +
        (
          i18n.t("static.supplyPlan.runDate") +
          " : " +
          moment(new Date()).format(`${DATE_FORMAT_CAP}`)
        ).replaceAll(" ", "%20") +
        '"'
    );
    csvRow.push("");
    csvRow.push(
      '"' +
        (
          i18n.t("static.supplyPlan.runTime") +
          " : " +
    ...
    if (
      ...
      csvRow.push(
        '"' +
          (i18n.t("static.supplyPlan.minStockMos").replaceAll(" ", "%20") +
            " : " +
            this.state.stockStatusList[0].minMos +
            '"')
      );
      csvRow.push(
        '"' +
          (i18n.t("static.supplyPlan.maxStockMos").replaceAll(" ", "%20") +
            " : " +
            this.state.stockStatusList[0].maxMos +
            '"')
      );
    } else {
      csvRow.push(
        '"' +
          (i18n.t("static.product.minQuantity").replaceAll(" ", "%20") +
            " : " +
            this.state.stockStatusList[0].minStock +
            '"')
      );
      csvRow.push(
        '"' +
          (i18n
            .t("static.product.distributionLeadTime")
            .replaceAll(" ", "%20") +
            " : " +
            this.state.stockStatusList[0].distributionLeadTime +
            '"')
      );
    }
    var ppu = this.state.planningUnits.filter(
      (c) =>
        c.planningUnit.id == document.getElementById("planningUnitId").value
    )[0];
    csvRow.push(
      '"' +
        (i18n.t("static.supplyPlan.amcPast").replaceAll(" ", "%20") +
          " : " +
          ppu.monthsInPastForAmc +
          '"')
    );
    csvRow.push(
      '"' +
        (i18n.t("static.supplyPlan.amcFuture").replaceAll(" ", "%20") +
          " : " +
    ...
    const headers = [
      this.addDoubleQuoteToRowContent([
        i18n.t("static.common.month").replaceAll(" ", "%20"),
        ...
        (
          ...
          " | " +
          i18n.t("static.mt.roNoAndPrimeLineNo") +
          " | " +
          i18n.t("static.mt.orderNoAndPrimeLineNo"),
        ...
        this.state.stockStatusList[0].planBasedOn == 1
          ...
          : i18n.t("static.supplyPlan.maxQty").replaceAll(" ", "%20"),
    ...
    var A = headers;
    this.state.stockStatusList.map((ele) =>
      A.push(
        this.addDoubleQuoteToRowContent([
          this.dateFormatterCSV(ele.dt).replaceAll(" ", "%20"),
          ele.openingBalance,
          ele.forecastedConsumptionQty == null
            ? ""
            : ele.forecastedConsumptionQty,
          ele.actualConsumptionQty == null ? "" : ele.actualConsumptionQty,
          ele.shipmentQty == null ? "" : ele.shipmentQty,
          ele.shipmentInfo
            .map((item) => {
              return (
                item.shipmentQty +
                ...
                " | " +
                getLabelText(item.shipmentStatus.label, this.state.lang) +
                " | " +
                item.procurementAgent.code +
                (item.orderNo == null &&
            ...
            .replaceAll(" ", "%20"),
          ele.adjustment == 0
            ? ele.regionCountForStock > 0
              ? ele.nationalAdjustment
              : ""
            : ele.regionCountForStock > 0
            ? ele.nationalAdjustment
            : ele.adjustment != null
            ? ele.adjustment
            : "",
          ele.expiredStock != 0 ? ele.expiredStock : "",
          ele.closingBalance,
          ele.amc != null ? this.formatAmc(ele.amc) : "",
          ele.planBasedOn == 1
            ? ele.mos != null
              ? this.roundN(ele.mos)
              : i18n.t("static.supplyPlanFormula.na")
            : ele.maxStock != null
            ? this.roundN(ele.maxStock)
            : "",
          ele.unmetDemand != 0 ? ele.unmetDemand : "",
        ])
      )
    );
    ...
    var list = this.state.PlanningUnitDataForExport.filter(
      (c) =>
        c.planningUnit.id != document.getElementById("planningUnitId").value
    );
    list.map((item) => {
        ...
        csvRow.push(
          '"' +
            (i18n
              ...
              .replaceAll(" ", "%20") +
              " : " +
              item.data[0].distributionLeadTime +
              '"')
        );
      }
      var ppu = this.state.planningUnits.filter(
        (c) => c.planningUnit.id == item.planningUnit.id
      )[0];
      csvRow.push(
        '"' +
          (i18n.t("static.supplyPlan.amcPast").replaceAll(" ", "%20") +
      ...
      const headers = [
        this.addDoubleQuoteToRowContent([
          ...
          i18n.t("static.shipment.qty") +
            ...
            i18n.t("static.budget.fundingsource") +
            " | " +
            i18n.t("static.supplyPlan.shipmentStatus").replaceAll(" ", "%20") +
            " | " +
            i18n.t("static.report.procurementAgentName") +
            " | " +
            i18n.t("static.mt.roNoAndPrimeLineNo") +
          ...
          i18n.t("static.supplyPlan.endingBalance").replaceAll(" ", "%20"),
          i18n.t("static.report.amc").replaceAll(" ", "%20"),
          item.data.length > 0 && item.data[0].planBasedOn == 1
            ? i18n.t("static.report.mos").replaceAll(" ", "%20")
            : i18n.t("static.supplyPlan.maxQty").replaceAll(" ", "%20"),
          i18n.t("static.supplyPlan.unmetDemandStr").replaceAll(" ", "%20"),
          // i18n.t('static.report.maxmonth').replaceAll(' ', '%20')]
            ...
            ele.shipmentInfo
              .map((item1) => {
                return (
                  item1.shipmentQty +
                  " | " +
                  item1.fundingSource.code +
                  " | " +
                  getLabelText(item1.shipmentStatus.label, this.state.lang) +
                  " | " +
                  item1.procurementAgent.code +
                  (item1.orderNo == null &&
    ...
    a.target = "_Blank";
    a.download =
      i18n.t("static.dashboard.stockstatus") +
      "-" +
  ...
  exportPDF = () => {
      ...
      for (var i = 1; i <= pageCount; i++) {
        ...
        if (i == 1) {
          ...
          doc.text(
            i18n.t("static.program.program") +
              " : " +
              (this.state.programs.filter(
                (c) => c.programId == document.getElementById("programId").value
              )[0].programCode +
                " " +
                i18n.t("static.supplyPlan.v") +
                document.getElementById("versionId").selectedOptions[0].text),
          ...
          var ppu = this.state.planningUnits.filter(
            (c) =>
              c.planningUnit.id ==
              document.getElementById("planningUnitId").value
          )[0];
          doc.text(
            i18n.t("static.supplyPlan.amcPast") +
              " : " +
              ppu.monthsInPastForAmc,
            doc.internal.pageSize.width / 10,
            100,
          ...
          doc.text(
            i18n.t("static.supplyPlan.amcFuture") +
              " : " +
              ppu.monthsInFutureForAmc,
            doc.internal.pageSize.width / 10,
            110,
          ...
          if (ppu.planBasedOn == 1) {
            doc.text(
              i18n.t("static.supplyPlan.minStockMos") +
                " : " +
                this.state.stockStatusList[0].minMos,
              doc.internal.pageSize.width / 10,
              130,
            ...
            doc.text(
              i18n.t("static.product.minQuantity") +
                " : " +
                this.formatter(ppu.minQty),
              doc.internal.pageSize.width / 10,
              130,
              {
                align: "left",
          ...
          doc.text(
            i18n.t("static.supplyPlan.reorderInterval") +
              " : " +
              ppu.reorderFrequencyInMonths,
            doc.internal.pageSize.width / 10,
            140,
            {
              align: "left",
          ...
          if (ppu.planBasedOn == 1) {
            doc.text(
              i18n.t("static.supplyPlan.maxStockMos") +
                " : " +
                this.state.stockStatusList[0].maxMos,
              doc.internal.pageSize.width / 10,
              150,
            ...
            doc.text(
              i18n.t("static.product.distributionLeadTime") +
                " : " +
                this.formatter(ppu.distributionLeadTime),
              doc.internal.pageSize.width / 10,
              150,
              {
                align: "left",
    ...
    const header = [
      [
        { content: i18n.t("static.common.month"), rowSpan: 2 },
      ...
      [
        ...
        i18n.t("static.supplyPlan.qty") +
          " | " +
          i18n.t("static.supplyPlan.funding") +
          " | " +
          i18n.t("static.shipmentDataEntry.shipmentStatus") +
          " | " +
          i18n.t("static.supplyPlan.procAgent") +
          " | " +
          i18n.t("static.mt.roNoAndPrimeLineNo") +
          " | " +
          i18n.t("static.mt.orderNoAndPrimeLineNo"),
        ...
        this.state.stockStatusList[0].planBasedOn == 1
          ...
          : i18n.t("static.supplyPlan.maxQty"),
        i18n.t("static.supplyPlan.unmetDemandStr"),
        // i18n.t('static.report.maxmonth')
      ],
    ];

    let data = this.state.stockStatusList.map((ele) => [
      this.dateFormatter(ele.dt),
      this.formatter(ele.openingBalance),
      this.formatter(ele.forecastedConsumptionQty),
      this.formatter(ele.actualConsumptionQty),
      ...
      ele.expiredStock != 0 ? this.formatter(ele.expiredStock) : "",
      this.formatter(ele.closingBalance),
      this.formatter(this.formatAmc(ele.amc)),
      ele.planBasedOn == 1
        ? ele.mos != null
          ? this.formatter(this.roundN(ele.mos))
          : i18n.t("static.supplyPlanFormula.na")
        : ele.maxStock != null
        ? this.formatter(this.roundN(ele.maxStock))
        : "",
      ele.unmetDemand != 0 ? this.formatter(ele.unmetDemand) : "",
    ]);
    ...
    let content = {
      ...
      didParseCell: function (data) {
        if (data.column.index === 8 && data.row.section != "head") {
          if (
            this.state.stockStatusList[data.row.index].regionCount ==
            this.state.stockStatusList[data.row.index].regionCountForStock
          ) {
        ...
        if (data.column.index === 1 && data.row.section != "head") {
          if (data.row.index == 0) {
            if (
              this.state.firstMonthRegionCount ==
              this.state.firstMonthRegionCountForStock
            ) {
              data.cell.styles.fontStyle = "bold";
            }
          } else {
            if (
              this.state.stockStatusList[data.row.index - 1].regionCount ==
              this.state.stockStatusList[data.row.index - 1].regionCountForStock
            ) {
              data.cell.styles.fontStyle = "bold";
            }
          }
    ...
    this.state.coList.map((ele) => {
      if (ele.notes != null && ele.notes != "") {
        ...
        if (cnt == 1) {
          ...
          doc.setFont("helvetica", "normal");
          doc.text(
            i18n.t("static.supplyPlan.consumptionMsg"),
            doc.internal.pageSize.width / 9,
            y,
            {
              align: "left",
        ...
        doc.text(
          ele.actualFlag.toString() == "true"
            ? moment(ele.consumptionDate).format("DD-MMM-YY") + "*"
            : moment(ele.consumptionDate).format("DD-MMM-YY") + "",
          doc.internal.pageSize.width / 8,
          y,
          {
        ...
        var splitTitle = doc.splitTextToSize(
          "(" +
            ...
            " | " +
            getLabelText(ele.dataSource.label, this.state.lang) +
            ") " +
            ele.notes.replace(/[\r\n]+/gm, " "),
    ...
    this.state.shList.map((ele) => {
      if (ele.notes != null && ele.notes != "") {
        ...
        doc.text(
          moment(
            ele.receivedDate == null || ele.receivedDate == ""
              ? ele.expectedDeliveryDate
              : ele.receivedDate
          ).format("DD-MMM-YY"),
          doc.internal.pageSize.width / 8,
          y,
    ...
    this.state.inList.map((ele) => {
      if (ele.notes != null && ele.notes != "") {
        ...
        if (cnt == 1) {
          ...
          doc.setFont("helvetica", "normal");
          doc.text(
            i18n.t("static.supplyPlan.inventoryMsg"),
            doc.internal.pageSize.width / 9,
            y,
            {
              align: "left",
        ...
        doc.text(
          ele.actualQty !== "" &&
            ele.actualQty != undefined &&
            ele.actualQty != null
            ? moment(ele.inventoryDate).format("DD-MMM-YY") + ""
            : moment(ele.inventoryDate).format("DD-MMM-YY") + "*",
          doc.internal.pageSize.width / 8,
          y,
          {
    ...
    pageArray.push({
      ...
      planningUnit:
        document.getElementById("planningUnitId").selectedOptions[0].text,
      min: this.state.stockStatusList[0].minMos,
      max: this.state.stockStatusList[0].maxMos,
      amcPast: ppu.monthsInPastForAmc,
      amcFuture: ppu.monthsInFutureForAmc,
      minStock: ppu.minQty,
      distributionLeadTime: ppu.distributionLeadTime,
      planBasedOn: ppu.planBasedOn,
    });
    var list = this.state.PlanningUnitDataForExport.filter(
      (c) =>
        c.planningUnit.id != document.getElementById("planningUnitId").value
    ...
    var count = 0;
    list.map((item, itemCount) => {
      doc.addPage();
      doc.setFontSize(8);
      var ppu1 = this.state.planningUnits.filter(
        (c) => c.planningUnit.id == item.planningUnit.id
      )[0];
      doc.text(
        i18n.t("static.planningunit.planningunit") +
      ...
      doc.text(
        i18n.t("static.supplyPlan.amcPast") + " : " + ppu1.monthsInPastForAmc,
        doc.internal.pageSize.width / 10,
        100,
        {
          align: "left",
      ...
      doc.text(
        i18n.t("static.report.shelfLife") + " : " + ppu1.shelfLife,
        doc.internal.pageSize.width / 10,
        120,
        {
          align: "left",
      ...
      if (ppu1.planBasedOn == 1) {
        doc.text(
          i18n.t("static.supplyPlan.minStockMos") + " : " + item.data[0].minMos,
          doc.internal.pageSize.width / 10,
          130,
          {
            align: "left",
      ...
      if (ppu1.planBasedOn == 1) {
        doc.text(
          i18n.t("static.supplyPlan.maxStockMos") + " : " + item.data[0].maxMos,
          doc.internal.pageSize.width / 10,
          150,
          {
            align: "left",
        ...
        doc.text(
          i18n.t("static.product.distributionLeadTime") +
            " : " +
            this.formatter(ppu1.distributionLeadTime),
          doc.internal.pageSize.width / 10,
          150,
          {
            align: "left",
      ...
      var height = doc.internal.pageSize.height;
      let otherdata = item.data.map((ele) => [
        this.dateFormatter(ele.dt),
        this.formatter(ele.openingBalance),
        this.formatter(ele.forecastedConsumptionQty),
        this.formatter(ele.actualConsumptionQty),
      ...
      let content = {
        ...
        didParseCell: function (data) {
          if (data.column.index === 8 && data.row.section != "head") {
            if (
              item.data[data.row.index].regionCount ==
              item.data[data.row.index].regionCountForStock
            ) {
              data.cell.styles.fontStyle = "bold";
            }
          }
          if (data.column.index === 1 && data.row.section != "head") {
            if (data.row.index == 0) {
              if (
                item.firstMonthRegionCount == item.firstMonthRegionCountForStock
              ) {
                data.cell.styles.fontStyle = "bold";
              }
            } else {
              if (
                item.data[data.row.index - 1].regionCount ==
                item.data[data.row.index - 1].regionCountForStock
              ) {
                data.cell.styles.fontStyle = "bold";
              }
            }
      ...
      pageArray.push({
        ...
        planningUnit: getLabelText(item.planningUnit.label, this.state.lang),
        min: item.data[0].minMos,
        max: item.data[0].maxMos,
        amcPast: ppu.monthsInPastForAmc,
        amcFuture: ppu.monthsInFutureForAmc,
        minStock: ppu.minQty,
        distributionLeadTime: ppu.distributionLeadTime,
      ...
      if (versionId.includes("Local")) {
        ...
        openRequest.onsuccess = function (e) {
          ...
          programRequest.onsuccess = function (event) {
            ...
            var gprogramDataBytes = CryptoJS.AES.decrypt(
              programDataJson.generalData,
              SECRET_KEY
            );
            var gprogramData = gprogramDataBytes.toString(CryptoJS.enc.Utf8);
            var gprogramJson = JSON.parse(gprogramData);
            var linkedShipmentsList =
              gprogramJson.shipmentLinkingList != null
                ? gprogramJson.shipmentLinkingList
                : [];
            ...
            var generalProgramData = generalProgramDataBytes.toString(
              CryptoJS.enc.Utf8
            );
            ...
            var realmRequest = realmOs.get(
              generalProgramJson.realmCountry.realm.realmId
            );
            ...
            realmRequest.onsuccess = function (event) {
              ...
              dsRequest.onsuccess = function (event) {
                ...
                var fsTransaction = db1.transaction(
                  ["fundingSource"],
                  "readwrite"
                );
                ...
                fsRequest.onsuccess = function (event) {
                  ...
                  paRequest.onsuccess = function (event) {
                    ...
                    var DEFAULT_MIN_MAX_MONTHS_OF_STOCK =
                    ...
                    if (
                      ...
                      maxForMonths + pu.reorderFrequencyInMonths
                    ) {
                    ...
                    var shipmentList = programJson.shipmentList.filter(
                      (c) =>
                    ...
                    var consumptionList = programJson.consumptionList.filter(
                      (c) =>
                        (c.active == true || c.active == "true") &&
                        c.planningUnit.id == planningUnitId
                    );
                    var inList = programJson.inventoryList.filter(
                      (c) =>
                        (c.active == true || c.active == "true") &&
                        c.planningUnit.id == pu.planningUnit.id &&
                        moment(c.inventoryDate) >= startDate &&
                        moment(c.inventoryDate) <= endDate
                    );
                    var coList = consumptionList.filter(
                      (c) =>
                        moment(c.consumptionDate) >= startDate &&
                        moment(c.consumptionDate) <= endDate
                    );
                    var shList = shipmentList.filter((c) =>
                      c.receivedDate != "" &&
                      c.receivedDate != null &&
                      c.receivedDate != undefined &&
                      c.receivedDate != "Invalid date"
                        ? moment(c.receivedDate) >= startDate &&
                          moment(c.receivedDate) <= endDate
                        : moment(c.expectedDeliveryDate) >= startDate &&
                          moment(c.expectedDeliveryDate) <= endDate
                    );
                    inList.map((c, idx) => {
                      var dataSource = dsResult.filter(
                        (d) => d.dataSourceId == c.dataSource.id
                      );
                    ...
                    shList.map((c, idx) => {
                      ...
                      for (var l = 0; l < linkedShipmentsList.length; l++) {
                        if (
                          shList[idx].parentShipmentId ==
                          linkedShipmentsList[l].parentShipmentId
                        ) {
                          shList[idx].roNo = linkedShipmentsList[l].roNo;
                          shList[idx].roPrimeLineNo =
                            linkedShipmentsList[l].roPrimeLineNo;
                        }
                      }
                    });
                    ...
                    var prevMonthSupplyPlan = programJson.supplyPlan.filter(
                      (c) =>
                        c.planningUnitId == planningUnitId &&
                        c.transDate ==
                          moment(startDate)
                            .subtract(1, "months")
                            .format("YYYY-MM-DD")
                    ...
                    if (prevMonthSupplyPlan.length > 0) {
                      this.setState({
                        firstMonthRegionCount:
                          prevMonthSupplyPlan[0].regionCount,
                        firstMonthRegionCountForStock:
                          prevMonthSupplyPlan[0].regionCountForStock,
                      });
                    } else {
                      this.setState({
                    ...
                    for (
                      ...
                      for (var month = monthstartfrom; month <= 12; month++) {
                        ...
                        console.log(list);
                        if (list.length > 0) {
                          var shiplist = shipmentList.filter((c) =>
                            c.receivedDate == null || c.receivedDate == ""
                              ? c.expectedDeliveryDate >= dt &&
                                c.expectedDeliveryDate <= enddtStr
                              : c.receivedDate >= dt &&
                                c.receivedDate <= enddtStr
                          );
                          var totalShipmentQty = 0;
                          shiplist.map((elt, idx) => {
                            totalShipmentQty =
                              totalShipmentQty + Number(elt.shipmentQty);
                            var fundingSource = fsResult.filter(
                              (fs) => fs.fundingSourceId == elt.fundingSource.id
                            );
                            ...
                            var procurementAgent = paResult.filter(
                              (pa) =>
                                pa.procurementAgentId == elt.procurementAgent.id
                            );
                          ...
                          var conList = consumptionList.filter(
                            (c) =>
                              c.actualFlag == false &&
                              c.consumptionDate >= dt &&
                              c.consumptionDate <= enddtStr
                          );
                          var totalforecastConsumption = null;
                          conList.map((elt) => {
                            totalforecastConsumption =
                              totalforecastConsumption == null
                                ? elt.consumptionQty
                                : totalforecastConsumption + elt.consumptionQty;
                          });
                          var conListAct = consumptionList.filter(
                            (c) =>
                              c.actualFlag == true &&
                              c.consumptionDate >= dt &&
                              c.consumptionDate <= enddtStr
                          ...
                          conListAct.map((elt) => {
                            totalActualConsumption =
                              totalActualConsumption == null
                                ? elt.consumptionQty
                                : totalActualConsumption + elt.consumptionQty;
                          });
                          console.log(conList);
                          ...
                          var json = {
                            ...
                            forecastedConsumptionQty: Number(
                              totalforecastConsumption
                            ),
                        ...
                        this.setState({
                          loading: false,
                          planningUnitLabel:
                            document.getElementById("planningUnitId")
        ...
        ReportService.getStockStatusData(inputjson)
          .then((response) => {
            ...
            var filteredResponseData = response.data.filter(
              (c) =>
                moment(c.dt).format("YYYY-MM") >=
            ...
            this.setState({
              firstMonthRegionCount:
                response.data.length > 0 ? response.data[0].regionCount : 1,
              firstMonthRegionCountForStock:
                response.data.length > 0
                  ? response.data[0].regionCountForStock
                  : 0,
              stockStatusList: filteredResponseData,
              message: "",
              loading: false,
              planningUnitLabel:
                document.getElementById("planningUnitId").selectedOptions[0]
                  .text,
            ...
            dsRequest.onsuccess = function (event) {
              ...
              fsRequest.onsuccess = function (event) {
                ...
                paRequest.onsuccess = function (event) {
                  ...
                  var selectedplanningunit = this.state.planningUnits.filter(
                    (c) =>
                      c.planningUnit.id ==
                      document.getElementById("planningUnitId").value
                  )[0];
                  console.log("selectedplanningunit", selectedplanningunit);
                  var planningunitList = this.state.planningUnits.filter(
                    (c) =>
                      c.planningUnit.id !=
                      document.getElementById("planningUnitId").value
                  );
                  ...
                  planningunitList.map((pu) => {
                    var planningUnitDataIndex = planningUnitDataList.findIndex(
                      (c) => c.planningUnitId == pu.planningUnit.id
                    );
                    var programJson = {};
                    if (planningUnitDataIndex != -1) {
                      var planningUnitData = planningUnitDataList.filter(
                      ...
                      var programData = programDataBytes.toString(
                        CryptoJS.enc.Utf8
                      );
                      programJson = JSON.parse(programData);
                    } else {
                    ...
                    var prevMonthSupplyPlan = programJson.supplyPlan.filter(
                      (c) =>
                        c.planningUnitId == pu.planningUnit.id &&
                        c.transDate ==
                          moment(startDate)
                            .subtract(1, "months")
                            .format("YYYY-MM-DD")
                          ...
                          let datasets = [
                            {
                              ...
                              type: "line",
                              stack: 7,
                              data: this.state.stockStatusList.map(
                                (item, index) =>
                                  item.expiredStock > 0
                                    ? item.expiredStock
                                    : null
                            ...
                            },
                            {
                              ...
                              data: data.map((item, index) => {
                                ...
                                item.shipmentInfo.map((ele, index) => {
                                  ele.shipmentStatus.id == 7
                                    ? (count = count + ele.shipmentQty)
                                    : (count = count);
                                });
                                return count;
                              }),
                            },
                            {
                              ...
                              data: data.map((item, index) => {
                                let count = 0;
                                item.shipmentInfo.map((ele, index) => {
                                  ele.shipmentStatus.id == 5 ||
                                  ele.shipmentStatus.id == 6
                                    ? (count = count + ele.shipmentQty)
                                    : (count = count);
                                });
                                return count;
                            ...
                            },
                            {
                              ...
                              data: data.map((item, index) => {
                                let count = 0;
                                item.shipmentInfo.map((ele, index) => {
                                  ele.shipmentStatus.id == 1 ||
                                  ele.shipmentStatus.id == 2 ||
                                  ele.shipmentStatus.id == 3 ||
                                  ele.shipmentStatus.id == 9
                                    ? (count = count + ele.shipmentQty)
                                    : (count = count);
                                });
                                return count;
...

                            {
                              ...
                              yValueFormatString: "$#,##0",
                              data: data.map(
                                (item, index) => item.finalConsumptionQty
                              ),
                            },
                            {
                              ...
                              showInLegend: true,
                              data: data.map(
                                (item, index) => item.closingBalance
                              ),
                            },
                          ];
                          if (data.length > 0 && data[0].planBasedOn == 1) {
                            datasets.push({
                              ...
                              data: data.map((item, index) => {
                                if (item.mos != "") {
                                  return Number(
                                    Math.round(item.mos * Math.pow(10, 1)) /
                                      Math.pow(10, 1)
                                  ).toFixed(1);
                                } else {
                                  return "";
                          ...
                          var chartOptions = {
                            title: {
                              ...
                              text:
                                ...
                                " - " +
                                getLabelText(
                                  pu.planningUnit.label,
                                  this.state.lang
                                ),
                            },
                            scales: {
                              yAxes:
                                data.length > 0 && data[0].planBasedOn == 1
                                  ? [
                                      {
                                        id: "A",
                                        position: "left",
                                      ...
                                      },
                                      {
                                        ...
                                        scaleLabel: {
                                          labelString: i18n.t(
                                            "static.supplyPlan.monthsOfStock"
                                          ),
                                          fontColor: "black",
                                          display: true,
                                        },
      ...
      ReportService.getStockStatusData(inputjson)
        .then((response) => {
          ...
          response.data.map((plannningUnitItem) => {
            ...
            var filteredPlanningUnitData = plannningUnitItem.filter(
              (c) =>
                moment(c.dt).format("YYYY-MM") >=
                moment(startDateForFilter).format("YYYY-MM")
            );
            var bar = {
              labels: filteredPlanningUnitData.map((item, index) =>
                this.dateFormatter(item.dt)
              ),
              datasets: [
                {
                  label: i18n.t("static.supplyplan.exipredStock"),
                  ...
                  data: this.state.stockStatusList.map((item, index) =>
                    item.expiredStock > 0 ? item.expiredStock : null
                  ),
                  fill: false,
                  borderColor: "rgb(75, 192, 192)",
                  tension: 0.1,
                ...
                },
                {
                  ...
                  data: filteredPlanningUnitData.map((item, index) => {
                    let count = 0;
                    item.shipmentInfo.map((ele, index) => {
                      ele.shipmentStatus.id == 5 || ele.shipmentStatus.id == 6
                        ? (count = count + ele.shipmentQty)
                        : (count = count);
                    });
                    return count;
...

                {
                  ...
                  data: filteredPlanningUnitData.map((item, index) => {
                    let count = 0;
                    item.shipmentInfo.map((ele, index) => {
                      ele.shipmentStatus.id == 3 || ele.shipmentStatus.id == 4
                        ? (count = count + ele.shipmentQty)
                        : (count = count);
                    });
                    return count;
                ...
                },
                {
                  ...
                  yValueFormatString: "$#,##0",
                  lineTension: 0,
                  data: filteredPlanningUnitData.map(
                    (item, index) => item.minMos
                  ),
                },
                {
                  type: "line",
            ...
            var chartOptions = {
              title: {
                ...
                text:
                  this.state.programs.filter(
                    (c) =>
                      c.programId == document.getElementById("programId").value
                  )[0].programCode +
                  " " +
                  i18n.t("static.supplyPlan.v") +
                  document.getElementById("versionId").selectedOptions[0].text +
                  " - " +
                  getLabelText(
                    plannningUnitItem[0].planningUnit.label,
                    this.state.lang
                  ),
              },
              scales: {
            ...
            var shipList = [];
            filteredData.map((c) =>
              c.consumptionInfo.map((ci) => conList.push(ci))
            );
            filteredData.map((c) =>
              c.inventoryInfo.map((ii) => invList.push(ii))
            );
            filteredData.map((c) =>
              c.shipmentInfo.map((si) => shipList.push(si))
            );
            ...
            var planningUnitexport = {
              ...
              firstMonthRegionCountForStock:
                data.length > 0 ? data[0].regionCountForStock : 0,
              data: filteredData,
              bar: bar,
              chartOptions: chartOptions,
              inList: invList,
      ...
      () => {
        if (versionId == 0) {
          ...
          if (versionId.includes("Local")) {
            ...
            ProgramService.getActiveProgramPlaningUnitListByProgramId(programId)
              .then((response) => {
                console.log("**" + JSON.stringify(response.data));
  ...
  render() {
    ...
    const options = {
      title: {
        display: true,
        text:
          this.state.planningUnitLabel != "" &&
          this.state.planningUnitLabel != undefined &&
          this.state.planningUnitLabel != null
            ? this.state.programs.filter(
                (c) => c.programId == document.getElementById("programId").value
              )[0].programCode +
              " " +
    ...
    let datasets = [
      ...
      },
      {
        ...
        data: this.state.stockStatusList.map((item, index) => {
          ...
          item.shipmentInfo.map((ele, index) => {
            ele.shipmentStatus.id == 7
              ? (count = count + Number(ele.shipmentQty))
              : (count = count);
          });
          return count;
        }),
    ...
    if (
      ...
      datasets.push({
        ...
        yValueFormatString: "$#,##0",
        data: this.state.stockStatusList.map((item, index) =>
          item.mos != null ? this.roundN(item.mos) : item.mos
        ),
      });
    }
    const bar = {
      labels: this.state.stockStatusList.map((item, index) =>
        this.dateFormatter(item.dt)
      ),
      datasets: datasets,
    };
            ...
            <div className="card-header-actions">
              <a className="card-header-action">
                <span
                  ...
                  onClick={() => {
                    this.refs.formulaeChild.toggle();
                  }}
                >
              ...
              <div ref={ref}>
                ...
                >
                      ...
                      <div className="col-md-12 p-0">
                        <div className="col-md-12">
                          <div className="chart-wrapper chart-graph-report">
                            ...
                            {this.state.stockStatusList[0].planBasedOn == 2 && (
                              <Bar
                                id="cool-canvas"
                                data={bar}
                                options={options1}
                          ...
                          <div id="bars_div" style={{ display: "none" }}>
                            ...
                            {this.state.PlanningUnitDataForExport.filter(
                              (c) =>
                                c.planningUnit.id !=
                                document.getElementById("planningUnitId").value
                            ).map((ele, index) => {
                              return (
                                <>
                                  {ele.data[0].planBasedOn == 1 && (
                                    <div className="chart-wrapper chart-graph-report">
                                      <Bar
                                        id={"cool-canvas" + index}
                                        data={ele.bar}
                                        options={ele.chartOptions}
                                      />
                                    </div>
                                  )}
                                  {ele.data[0].planBasedOn == 2 && (
                                    <div className="chart-wrapper chart-graph-report">
                                      <Bar
                                        id={"cool-canvas" + index}
                                        data={ele.bar}
                        ...
                        <div className="col-md-12">
                          <button
                            className="mr-1 mt-1 mb-2 float-right btn btn-info btn-md showdatabtn"
                          ...
                          {this.state.stockStatusList[0].planBasedOn == 1 ? (
                            ...
                            <>
                              ...
                              <li>
                                ...
                                <span className="legendcommitversionText">
                                  {i18n.t(
                                    "static.product.distributionLeadTime"
                                  )}{" "}
                                  :{" "}
                                  {this.formatter(
                                    this.state.stockStatusList[0]
                        ...
                        <ul className="legendcommitversion list-group">
                          {
                            <>
                              <li>
                                ...
                                ></span>{" "}
                                <span className="legendcommitversionText">
                                  {i18n.t("static.report.stockout")}
                                </span>
                              </li>
                              <li>
                                <span
                                  className="legendcolor"
                                  style={{ backgroundColor: "#f48521" }}
                                ></span>{" "}
                                <span className="legendcommitversionText">
                                  {i18n.t("static.report.lowstock")}
                                </span>
                              </li>
                              <li>
                                <span
                                  className="legendcolor"
                                  style={{ backgroundColor: "#118b70" }}
                                ></span>{" "}
                                <span className="legendcommitversionText">
                                  {i18n.t("static.report.okaystock")}
                                </span>
                              </li>
                              <li>
                                <span
                                  className="legendcolor"
                                  style={{ backgroundColor: "#edb944" }}
                                ></span>{" "}
                                <span className="legendcommitversionText">
                                  {i18n.t("static.report.overstock")}
                                </span>
                              </li>
                              <li>
                                <span
                  ...
                  {this.state.show && this.state.stockStatusList.length > 0 && (
                    <Table
                      responsive
                      className="table-striped table-bordered text-center mt-2"
                    >
                      <thead>
                        <tr>
                        ...
                        {this.state.stockStatusList.length > 0 &&
                          this.state.stockStatusList.map((item, idx) => (
                            <tr id="addr0" key={idx}>
                              <td>
                                {this.dateFormatter(
                                  this.state.stockStatusList[idx].dt
                                )}
                              </td>
                              {(idx == 0
                                ? this.state.firstMonthRegionCount
                                : this.state.stockStatusList[idx - 1]
                                    .regionCount) ==
                              (idx == 0
                                ? this.state.firstMonthRegionCountForStock
                                : this.state.stockStatusList[idx - 1]
                                ...
                                <td>
                                  <b>
                                    {this.formatter(
                                      this.state.stockStatusList[idx]
                                        .openingBalance
                                    )}
                                  </b>
                                </td>
                              ...
                              <td
                                className={this.rowtextFormatClassName(
                                  this.state.stockStatusList[idx]
                                )}
                              >
                                {this.formatter(
                              ...
                              <td>
                                {this.formatter(
                                  this.state.stockStatusList[idx].shipmentQty
                                )}
                              </td>
                              <td align="center">
                                <table>
                                  {this.state.stockStatusList[
                                    idx
                                  ].shipmentInfo.map((item, index) => {
                                    return (
                                      <tr>
                                        <td padding="0">
                                          {this.formatter(item.shipmentQty) +
                                            `   |    ${item.fundingSource.code}    |    ${item.shipmentStatus.label.label_en}   |    ${item.procurementAgent.code}`}
                                          {item.orderNo == null &&
                                          item.primeLineNo == null &&
                                          item.roNo == null &&
                                          item.roPrimeLineNo == null
                              ...
                              <td>
                                {this.formatter(
                                  this.state.stockStatusList[idx].adjustment ==
                                    0
                                    ? this.state.stockStatusList[idx]
                                        .regionCountForStock > 0
                                      ? this.state.stockStatusList[idx]
                              ...
                              <td>
                                {this.state.stockStatusList[idx].expiredStock !=
                                0
                                  ? this.formatter(
                                      this.state.stockStatusList[idx]
                                        .expiredStock
                              ...
                              {this.state.stockStatusList[idx].regionCount ==
                              this.state.stockStatusList[idx]
                                .regionCountForStock ? (
                                <td
                                  style={{
                              ...
                              <td>
                                {this.formatter(
                                  this.formatAmc(
                                    this.state.stockStatusList[idx].amc
                                  )
                                )}
                              </td>
                              <td
                                style={{
                                  backgroundColor:
                                    this.state.stockStatusList[0].planBasedOn ==
                                    1
                              ...
                              >
                                {this.state.stockStatusList[0].planBasedOn == 1
                                  ? this.state.stockStatusList[idx].mos != null
                                    ? this.roundN(
                                        this.state.stockStatusList[idx].mos
                                      )
                                    : i18n.t("static.supplyPlanFormula.na")
                                  : this.formatter(
                                      this.state.stockStatusList[idx].maxStock
                                    )}
                              </td>
                              <td>
                                {this.state.stockStatusList[idx].unmetDemand !=
                                0
                                  ? this.formatter(
                                      this.state.stockStatusList[idx]
                                        .unmetDemand
