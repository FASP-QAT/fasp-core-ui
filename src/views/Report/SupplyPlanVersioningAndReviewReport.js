...
export default class SupplyPlanVersioningAndReviewReport extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount() {
        ...
        ProgramService.getVersionStatusList.then(response => {
            ...
            if (response.status == 200) {
                this.setState({ versionStatusList: response.data });
            } else {
        ...
        ProgramService.getVersionTypeList.then(response => {
            // console.log("for program", response.data);
            if (response.status == 200) {
                this.setState({ versionTypeList: response.data });
            } else {
    ...
    formSubmit() {
        ...
        AuthenticationService.setupAxiosInterceptors();
        ReportService.getVersionInfo(-1,-1,-1,"2019-01-01",new Date).then(response => {
