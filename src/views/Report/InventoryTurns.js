  ...
  handleAMonthDissmis2 = (value) => {
    ...
    formSubmit() {
        ...
        ReportService.inventoryTurns(this.state.CostOfInventoryInput).then(response => {
            ...
            this.setState({ costOfInventory: [{"planningUnit":{"id":152,"label":{"active":false,"labelId":9098,"label_en":"Abacavir 20 mg/mL Solution, 240 mL","label_sp":null,"label_fr":null,"label_pr":null}},"totalConsumption":148417,"avergeStock":23023,"noOfMonths":7,"inventoryTurns":6.4462},
