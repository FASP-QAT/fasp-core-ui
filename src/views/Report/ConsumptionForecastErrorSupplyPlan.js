...
class ConsumptionForecastErrorSupplyPlan extends Component {
    ...
    exportCSV() {
        ...
        this.state.regionValues.map(r => {
            ...
            datacsv.push(((r.label) + " Error").replaceAll(' ', '%20'))
            {
                this.state.monthArray.map((item1, count) => {
                    ...
                    totalErrorRegion += (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? 0 : errorDataRegionData[0].errorPerc;
                    totalErrorRegionCount += (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? 0 : 1;
                    datacsv.push((errorDataRegionData[0].actualQty === '' || errorDataRegionData[0].actualQty == null) ? (errorDataRegionData[0].forecastQty === '' || errorDataRegionData[0].forecastQty == null) ? (((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : PercentageFormatter(errorDataRegionData[0].errorPerc * 100))+" (No months in this period contain both forecast and actual consumption)").replaceAll(' ', '%20') : (((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : PercentageFormatter(errorDataRegionData[0].errorPerc * 100))+" (No Actual Data)").replaceAll(' ', '%20') : errorDataRegionData[0].actualQty >= 0 ? ((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : PercentageFormatter(errorDataRegionData[0].errorPerc * 100)) : (((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : PercentageFormatter(errorDataRegionData[0].errorPerc * 100))+" (No Actual Data)").replaceAll(' ', '%20'))
                })
            }
        ...
        this.state.monthArray.map((item1, count) => {
            ...
            totalError += (isNaN(data[0].errorPerc) || data[0].errorPerc == null || data[0].errorPerc === '') ? 0 : parseFloat(data[0].errorPerc);
            countError += (isNaN(data[0].errorPerc) || data[0].errorPerc == null || data[0].errorPerc === '') ? 0 : 1;
            datacsv.push((data[0].actualQty === '' || data[0].actualQty == null) ? (data[0].forecastQty === '' || data[0].forecastQty == null) ? ((isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? '' : PercentageFormatter((data[0].errorPerc) * 100)+" (No months in this period contain both forecast and actual consumption)").replaceAll(' ', '%20') : ((isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? '' : PercentageFormatter((data[0].errorPerc) * 100)+" (No Actual Data)").replaceAll(' ', '%20') : data[0].actualQty >= 0 ? (isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? '' : PercentageFormatter((data[0].errorPerc) * 100) : ((isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? '' : PercentageFormatter((data[0].errorPerc) * 100)+" (No Actual Data)").replaceAll(' ', '%20'))
        })
    ...
    exportPDF = () => {
            ...
            this.state.regionValues.map(r => {
                ...
                A.push("" + (r.label) + " Error")
                {
                    this.state.monthArray.map((item1, count) => {
                        let errorData = this.state.dataList.filter(c => (moment(c.month).format("YYYY-MM") == moment(item1.date).format("YYYY-MM")));
                        let errorDataRegionData = (errorData[0].regionData.filter(arr1 => arr1.region.id == r.value));
                        totalRegion += (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? 0 : errorDataRegionData[0].errorPerc;
                        totalRegionCount += (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? 0 : 1;
                        A.push((errorDataRegionData[0].actualQty === '' || errorDataRegionData[0].actualQty == null) ? (errorDataRegionData[0].forecastQty === '' || errorDataRegionData[0].forecastQty == null) ? (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? "" : PercentageFormatter(errorDataRegionData[0].errorPerc * 100)+" (No Data)" : (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? "" : PercentageFormatter(errorDataRegionData[0].errorPerc * 100)+" (No Actual Data)" : errorDataRegionData[0].actualQty >= 0 ? (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? "" : PercentageFormatter(errorDataRegionData[0].errorPerc * 100) : (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? "" : PercentageFormatter(errorDataRegionData[0].errorPerc * 100) +" (No Actual Data)")
                    })
                }
        ...
        A.push('Total Error')
        {
            ...
            this.state.monthArray.map((item1, count) => {
                ...
                totalError += (isNaN(datavalue[0].errorPerc) || datavalue[0].errorPerc == null || datavalue[0].errorPerc === '') ? 0 : datavalue[0].errorPerc;
                countError += (isNaN(datavalue[0].errorPerc) || datavalue[0].errorPerc == null || datavalue[0].errorPerc === '') ? 0 : 1;
                A.push((datavalue[0].actualQty === '' || datavalue[0].actualQty == null) ? (datavalue[0].forecastQty === '' || datavalue[0].forecastQty == null) ? (isNaN(datavalue[0].errorPerc) || datavalue[0].errorPerc == null || datavalue[0].errorPerc === '') ? '' : PercentageFormatter(datavalue[0].errorPerc * 100)+" (No Data)" : (isNaN(datavalue[0].errorPerc) || datavalue[0].errorPerc == null || datavalue[0].errorPerc === '') ? '' : PercentageFormatter(datavalue[0].errorPerc * 100)+" (No Actual Data)" : datavalue[0].actualQty >= 0 ? (isNaN(datavalue[0].errorPerc) || datavalue[0].errorPerc == null || datavalue[0].errorPerc === '') ? '' : PercentageFormatter(datavalue[0].errorPerc * 100) : (isNaN(datavalue[0].errorPerc) || datavalue[0].errorPerc == null || datavalue[0].errorPerc === '') ? '' : PercentageFormatter(datavalue[0].errorPerc * 100)+" (No Actual Data)")
            })
                                                    ...
                                                    <Table className="table-bordered text-center mt-2 overflowhide main-table " bordered size="sm" >
                                                        ...
                                                        <tbody>
                                                            {this.state.regionValues.map(r => {
                                                                ...
                                                                return (<><tr>
                                                                    ...
                                                                    {this.state.monthArray.map((item1, count) => {
                                                                        let errorData = this.state.dataList.filter(c => (moment(c.month).format("YYYY-MM") == moment(item1.date).format("YYYY-MM")));
                                                                        let errorDataRegionData = (errorData[0].regionData.filter(arr1 => arr1.region.id == r.value));
                                                                        regionErrorTotal += (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? 0 : errorDataRegionData[0].errorPerc;
                                                                        regionErrorTotalCount += (isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? 0 : 1;
                                                                        return (<td title={(errorDataRegionData[0].actualQty === '' || errorDataRegionData[0].actualQty == null) ? (errorDataRegionData[0].forecastQty === '' || errorDataRegionData[0].forecastQty == null) ? i18n.t("static.forecastErrorReport.noData") : i18n.t("static.forecastErrorReport.noActualData") : errorDataRegionData[0].actualQty >= 0 ? ((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : "") : i18n.t("static.forecastErrorReport.noActualData")}><b>{(errorDataRegionData[0].actualQty === '' || errorDataRegionData[0].actualQty == null) ? (errorDataRegionData[0].forecastQty === '' || errorDataRegionData[0].forecastQty == null) ? ((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : <span className={this.state.showForecastThresholdLegend && (errorDataRegionData[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(errorDataRegionData[0].errorPerc * 100)}&nbsp;<i class="fa fa-exclamation-triangle red"></i></span>) : ((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : <span className={this.state.showForecastThresholdLegend && (errorDataRegionData[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(errorDataRegionData[0].errorPerc * 100)}&nbsp;<i class="fa fa-exclamation-triangle red"></i></span>) : errorDataRegionData[0].actualQty >= 0 ? ((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : <span className={this.state.showForecastThresholdLegend && (errorDataRegionData[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(errorDataRegionData[0].errorPerc * 100)}</span>) : ((isNaN(errorDataRegionData[0].errorPerc) || errorDataRegionData[0].errorPerc === '' || errorDataRegionData[0].errorPerc == null) ? '' : <span className={this.state.showForecastThresholdLegend && (errorDataRegionData[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(errorDataRegionData[0].errorPerc * 100)}&nbsp;<i class="fa fa-exclamation-triangle red"></i></span>)}</b></td>)
                                                                    })}
                                                            ...
                                                            <tr>
                                                                ...
                                                                {this.state.monthArray.map((item1, count) => {
                                                                    var data = this.state.dataList.filter(c => moment(c.month).format("YYYY-MM") == moment(item1.date).format("YYYY-MM"))
                                                                    totalError += (isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? 0 : data[0].errorPerc;
                                                                    countError += (isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? 0 : 1;
                                                                    return (<td title={(data[0].actualQty === '' || data[0].actualQty == null) ? (data[0].forecastQty === '' || data[0].forecastQty == null) ? i18n.t("static.forecastErrorReport.noData") : i18n.t("static.forecastErrorReport.noActualData") : data[0].actualQty >= 0 ? (isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? '' : "" : i18n.t("static.forecastErrorReport.noActualData")}><b>{(data[0].actualQty === '' || data[0].actualQty == null) ? (data[0].forecastQty === '' || data[0].forecastQty == null) ? (<span className={this.state.showForecastThresholdLegend && (data[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(data[0].errorPerc * 100)}&nbsp;<i class="fa fa-exclamation-triangle red"></i></span>) : (<span className={this.state.showForecastThresholdLegend && (data[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(data[0].errorPerc * 100)}&nbsp;<i class="fa fa-exclamation-triangle red"></i></span>) : data[0].actualQty >= 0 ? (isNaN(data[0].errorPerc) || data[0].errorPerc === '' || data[0].errorPerc == null) ? '' : <span className={this.state.showForecastThresholdLegend && (data[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(data[0].errorPerc * 100)}</span> : (<span className={this.state.showForecastThresholdLegend && (data[0].errorPerc * 100) > this.state.forecastErrorThreshold ? 'red' : ""}>{PercentageFormatter(data[0].errorPerc * 100)}&nbsp;<i class="fa fa-exclamation-triangle red"></i></span>)}</b></td>)
                                                                })}
