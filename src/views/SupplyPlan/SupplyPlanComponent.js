        ...
        if (cont == true) {
            this.setState({
                ...
                for (var j = 0; j < batchInfoList.length; j++) {
                    ...
                    data[4] = Number(roundARU(item.qty, this.state.multiplier)).toFixed(8);
                ...
                var options = {
                    ...
                    footers: [
                        [
                            ...
                            Number(roundARU(total, this.state.multiplier)).toString().replace(/\B(?<!\.\d*)(?=(\d{8})+(?!\d))/g, ","),
                    ...
                    onchange: function (instance, cell, x, y, value) {
                        ...
                        if (x == 5) {
                            ...
                            instance.setFooter([[
                                ...
                                this.formatter(Number(roundARU(totalProjected, this.state.multiplier)).toString().replace(/\B(?<!\.\d*)(?=(\d{8})+(?!\d))/g, ",")),
