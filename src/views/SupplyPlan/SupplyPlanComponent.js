        ...
        if (cont == true) {
            this.setState({
                ...
                for (var j = 0; j < batchInfoList.length; j++) {
                    ...
                    data[4] = Number(item.qty).toFixed(8);
                ...
                var options = {
                    ...
                    footers: [
                        [
                            ...
                            Number(total).toFixed(8).toString().replace(/\B(?<!\.\d*)(?=(\d{8})+(?!\d))/g, ","),
                            Number(total).toFixed(8).toString().replace(/\B(?<!\.\d*)(?=(\d{8})+(?!\d))/g, ",")
                        ],
                        [
                            '',
                            ...
                            Number(this.state.closingBalanceArray[count].balanceWithoutRounding).toFixed(8).toString().replace(/\B(?<!\.\d*)(?=(\d{8})+(?!\d))/g, ","),
                            Number(this.state.closingBalanceArray[count].balanceWithoutRounding).toFixed(8).toString().replace(/\B(?<!\.\d*)(?=(\d{8})+(?!\d))/g, ",")
                        ]
                    ],
                    onchange: function (instance, cell, x, y, value) {
                        ...
                        if (x == 5) {
                            ...
                            instance.setFooter([[
                                ...
                                this.formatter(Number(totalProjected).toFixed(8).toString().replace(/\B(?<!\.\d*)(?=(\d{8})+(?!\d))/g, ",")),
