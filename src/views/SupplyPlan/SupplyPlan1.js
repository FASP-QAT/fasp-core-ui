...
export default class SupplyPlanComponent extends React.Component {
    ...
    constructor(props) {
        ...
        this.shipmentStatusDropdownFilterForPsm = this.shipmentStatusDropdownFilterForPsm.bind(this);
        ...
        openRequest.onsuccess = function (e) {
            ...
            programRequest.onsuccess = function (event) {
                ...
                for (var i = 1; i <= 18; i++) {
                    ...
                    console.log("Inventroy Total data", inventoryTotalData);
                    ...
                    if (compare && parseInt(stockInHand) <= parseInt(minStockArray[s])) {
                        ...
                        if (suggestedOrd == 0) {
                            ...
                            console.log("Is emergy order", isEmergencyOrder);
                    ...
                    console.log("openingBalanceArray[i - 1]", openingBalanceArray[i - 1]);
                    console.log("consumptionQtyForCB", consumptionQtyForCB);
                    console.log("inventory", inventoryQtyForCB);
                    console.log("Closing balanmce", closingBalance);
                ...
                //     var addLeadTimes = parseInt(parseFloat(programJson.plannedToDraftLeadTime) + parseFloat(programJson.draftToSubmittedLeadTime) +
                //         parseFloat(programJson.submittedToApprovedLeadTime) + parseFloat(programJson.approvedToShippedLeadTime) + parseFloat(programJson.arrivedToDeliveredLeadTime) +
                    ...
                    dataSourceRequest.onsuccess = function (event) {
                        ...
                        var options = {
                            ...
                            columns: [
                                ...
                                { type: 'text' },
                                { type: 'hidden' },
                                { type: 'calendar', options: { format: 'MM-DD-YYYY' } },
                            ],
                            pagination: false,
                            search: false,
                            columnSorting: true,
    ...
    suggestedShipmentChanged = function (instance, cell, x, y, value) {
        ...
        if (x == 9) {
            ...
            console.log("isNaN(Date.parse(", isNaN(Date.parse(value)));
            if (value == "") {
                            ...
                            shipmentStatusRequest.onsuccess = function (event) {
                                ...
                                currencyRequest.onsuccess = function (event) {
                                    ...
                                    bRequest.onsuccess = function (event) {
                                        ...
                                        var shipmentList = programJson.shipmentList.filter(c => c.expectedDeliveryDate >= startDate && c.expectedDeliveryDate <= endDate && c.procurementAgent.id == 1 && c.erpFlag == false && c.shipmentStatus.id != 8);
                                ...
                                IF(L${i + 1}==4,
                                        ...
                                        IF(L${i + 1}==1,
                                            ...
                                            data[31] = index;
                                            data[32] = shipmentList[i].shipmentStatus.id;
                                            if (shipmentList[i].shipmentStatus.id == 1 || shipmentList[i].shipmentStatus.id == 2) {
                                                plannedShipmentsArr.push(data);
                                            } else if (shipmentList[i].shipmentStatus.id != 1 && shipmentList[i].shipmentStatus.id != 2 && shipmentList[i].shipmentStatus.id != 8) {
                                        ...
                                        var options = {
                                            ...
                                            columns: [
                                                ...
                                                { type: 'dropdown', title: "Shipment status", source: shipmentStatusList, filter: this.shipmentStatusDropdownFilterForPsm },
                                                ...
                                                { type: 'hidden', title: 'Current shipment status' }
                                            ],
                                            pagination: false,
                                            search: false,
                                            columnSorting: true,
    ...
    shipmentStatusDropdownFilterForPsm = function (instance, cell, c, r, source) {
        var mylist = [];
        var value = (instance.jexcel.getJson()[r])[32];
        if (value != "") {
            ...
            openRequest.onsuccess = function (e) {
                ...
                programRequest.onsuccess = function (event) {
                    ...
                    for (var j = 0; j < json.length; j++) {
                        ...
                        if (selectedShipmentStatus == 1 || selectedShipmentStatus == 2 || selectedShipmentStatus == 3) {
                                            ...
                                            IF(NOT(ISBLANK(N${i + 1})),
                                                ...
                                                var options = {
                                                    ...
                                                    columns: [
                                                        ...
                                                        { type: 'text', readOnly: true, title: "Adjusted pallets" },
                                                        { type: 'text', readOnly: true, title: "Adjusted containers" },
                                                        { type: 'text', title: "User price per planning unit", readOnly: true },
                                                        ...
                                                        { type: 'text', title: "User Freight cost amount", readOnly: true },
                                                        { type: 'text', readOnly: true, title: "Default freight cost" },
                                                        { type: 'text', readOnly: true, title: "Total amount" },
                                                        { type: 'text', title: "Notes" },
                                                        { type: 'hidden', title: "Units/Pallet" },
                                            ...
                                            IF(NOT(ISBLANK(N${i + 1})),
                                                ...
                                                var options = {
                                                    ...
                                                    updateTable: function (el, cell, x, y, source, value, id) {
                                                        ...
                                                        if (shipmentStatus >= 3 && supplyPlanType == 'psmShipments' && shipmentStatus != 9) {
                                                            console.log("In if");
