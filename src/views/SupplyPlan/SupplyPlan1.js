...
export default class SupplyPlanComponent extends React.Component {
                ...
                <TabPane tabId="1">
                    ...
                    <Modal isOpen={this.state.consumption}
                        ...
                        <ModalBody>
                            ...
                            <h6 className="red">{this.state.consumptionBatchInfoDuplicateError}</h6>
                            <div className="table-responsive">
                    ...
                    <Modal isOpen={this.state.adjustments}
                        ...
                        <ModalBody>
                            ...
                            <h6 className="red">{this.state.inventoryBatchInfoDuplicateError}</h6>
                            <div className="table-responsive">
                    ...
                    <Modal isOpen={this.state.psmShipments}
                        ...
                        <ModalBody>
                            ...
                            <h6 className="red">{this.state.shipmentBatchInfoDuplicateError}</h6>
                            <div className="table-responsive">
    ...
    formSubmit(monthCount) {
        ...
        openRequest.onsuccess = function (e) {
            ...
            programRequest.onsuccess = function (e) {
                ...
                for (var i = 0; i < TOTAL_MONTHS_TO_DISPLAY_IN_SUPPLY_PLAN; i++) {
                    ...
                    for (var reg = 0; reg < regionListFiltered.length; reg++) {
                        ...
                        for (var j = 0; j < c.length; j++) {
                            ...
                            console.log("Adjustment qty", c[j].adjustmentQty);
                            console.log("Multiplier", c[j].multiplier);
                ...
                console.log("UnmetDemand", unmetDemand);
                    ...
                    countrySKURequest.onsuccess = function (event) {
                        ...
                        for (var k = 0; k < countrySKUResult.length; k++) {
                            if (countrySKUResult[k].realmCountry.id == programJson.realmCountry.realmCountryId) {
                                console.log("getLabelText(countrySKUResult[k].label, this.state.lang)", getLabelText(countrySKUResult[k].label, this.state.lang));
                                var countrySKUJson = {
                        ...
                        console.log("Country SKU List", countrySKUList);
                        this.setState({
                                ...
                                items.push({
                                    ...
                                    onclick: function () {
                                        ...
                                        for (var sb = 0; sb < batchInfo.length; sb++) {
                                            var data = [];
                                            data[0] = batchInfo[sb].batch.batchId;
                                            data[1] = batchInfo[sb].adjustmentQty;
                                            data[2] = batchInfo[sb].actualQty;
    ...
    batchInfoChangedInventory = function (instance, cell, x, y, value) {
        ...
        if (x == 2) {
            if (elInstance.getValueFromCoords(2, y) != "") {
                var reg = /^[0-9\b]+$/;
                if (isNaN(parseInt(value)) || !(reg.test(value))) {
                    ...
                    var col = ("C").concat(parseInt(y) + 1);
                    // var manualAdj = elInstance.getValueFromCoords(9, y) - elInstance.getCell(`F${y}`).innerText;
                    // console.log("elInstance.getValueFromCoords(5, y)", elInstance.getCell(`F${y}`).innerText);
        ...
        if (validation == true) {
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                var batchInfoJson = {
                    ...
                    adjustmentQty: map.get("1"),
                    actualQty: map.get("2")
                }
                batchInfoArray.push(batchInfoJson);
                totalAdjustments += parseInt(map.get('1'));
                totalActualStock += parseInt(map.get("2"))
            }
        ...
        if (x == 9) {
            if (elInstance.getValueFromCoords(9, y) != "") {
                ...
                if (isNaN(parseInt(value)) || !(reg.test(value))) {
                    ...
                    var col = ("J").concat(parseInt(y) + 1);
                    if (elInstance.getValueFromCoords(5, y) != "" && elInstance.getValueFromCoords(9, y) != "") {
                        var manualAdj = elInstance.getValueFromCoords(9, y) - elInstance.getCell(`F${y}`).innerText;
                        console.log("elInstance.getValueFromCoords(5, y)", elInstance.getCell(`F${y}`).innerText);
                        elInstance.setValueFromCoords(7, y, parseInt(manualAdj), true);
                        elInstance.setStyle(col, "background-color", "transparent");
