                                        ...
                                        currencyRequest.onsuccess = function (event) {
                                            ...
                                            var options = {
                                                ...
                                                columns: [
                                                    ...
                                                    { title: i18n.t('static.shipment.shipmentQtyPU'), type: 'numeric', mask: (localStorage.getItem("roundingEnabled") != undefined && localStorage.getItem("roundingEnabled").toString() == "false") ? '#,##.00' : '#,##', decimal: '.', width: 120, readOnly: true },
