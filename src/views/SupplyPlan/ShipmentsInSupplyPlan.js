        ...
        if (x == 5) {
            ...
            if (validation && rowData[28] != "") {
                ...
                for (var b = 0; b < batchDetails.length; b++) {
                    ...
                    shipmentListUnFiltered.filter(c => (c.shipmentId != 0 ? c.shipmentId != rowData[2] : c.index != rowData[27]) && c.active.toString() == "true" && c.accountFlag.toString() == "true" && c.shipmentStatus.id != CANCELLED_SHIPMENT_STATUS)
                        .map(c => {
