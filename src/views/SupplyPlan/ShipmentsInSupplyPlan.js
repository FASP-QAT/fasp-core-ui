        ...
        if (x == 4) {
            ...
            if (valid == true) {
                ...
                if (value == SUBMITTED_SHIPMENT_STATUS || value == ARRIVED_SHIPMENT_STATUS || value == SHIPPED_SHIPMENT_STATUS || value == DELIVERED_SHIPMENT_STATUS || value == APPROVED_SHIPMENT_STATUS) {
                    var budget = elInstance.getValueFromCoords(17, y, true)!="SELECT"?elInstance.getValueFromCoords(17, y, true):"";
        ...
        for (var y = 0; y < json.length; y++) {
            ...
            if (checkOtherValidation) {
                ...
                if (validation == true) {
                    ...
                    if (elInstance.getValueFromCoords(17, y, true) != "" && elInstance.getValueFromCoords(17, y, true)!="SELECT" && elInstance.getValueFromCoords(17, y, true) != undefined && elInstance.getValueFromCoords(17, y, true) != "undefined" && map.get("18") != "" && map.get("4") != CANCELLED_SHIPMENT_STATUS && map.get("33").toString() != "false" && map.get("0").toString() != "false") {
