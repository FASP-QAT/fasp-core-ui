...
export default class InventoryInSupplyPlanComponent extends React.Component {
                ...
                rcpuRequest.onsuccess = function (event) {
                    ...
                    dataSourceRequest.onsuccess = function (event) {
                        ...
                        for (var j = 0; j < inventoryList.length; j++) {
                            ...
                            data[9] = `=ROUND(G${parseInt(j) + 1}*I${parseInt(j) + 1},0)`; 
                            data[10] = `=ROUND(H${parseInt(j) + 1}*I${parseInt(j) + 1},0)`; 
                        ...
                        if (inventoryList.length == 0 && inventoryEditable) {
                            ...
                            data[6] = ""; 
                            data[7] = ""; 
                            data[8] = realmCountryPlanningUnitList.length == 1 ? realmCountryPlanningUnitList[0].multiplier : "";; 
                            data[9] = `=ROUND(G${parseInt(0) + 1}*I${parseInt(0) + 1},0)`; 
                            data[10] = `=ROUND(H${parseInt(0) + 1}*I${parseInt(0) + 1},0)`; 
                            data[11] = "";
                            data[12] = true;
                            if (this.props.inventoryPage != "inventoryDataEntry") {
    ...
    addRowInJexcel() {
        ...
        data[7] = ""; 
        data[8] = realmCountryPlanningUnitList.length == 1 ? realmCountryPlanningUnitList[0].multiplier : ""; 
        data[9] = `=ROUND(G${parseInt(json.length) + 1}*I${parseInt(json.length) + 1},0)`; 
        data[10] = `=ROUND(H${parseInt(json.length) + 1}*I${parseInt(json.length) + 1},0)`; 
        data[11] = "";
        data[12] = true;
        if (this.props.inventoryPage != "inventoryDataEntry") {
            data[13] = this.props.items.inventoryEndDate;
