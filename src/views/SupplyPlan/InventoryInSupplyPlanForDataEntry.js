                ...
                if (rowData[20].toString() == "true" || rowData[20].toString() == "1") {
                    ...
                    if (rowData[14] != "") {
                        ...
                        for (var b = 0; b < batchDetails.length; b++) {
                            console.log("B Test@123", b);
                            var bd = batchDetails[b];
                            var minCreatedDate = moment(rowData[1]).format("YYYY-MM-DD");
                            console.log("Min Created Date Test@123", minCreatedDate);
                        ...
                        console.log("Batch Details Test@123", batchDetails);
                            ...
                            if (json[i][0] == planningUnitId) {
                                ...
                                if (parseInt(map.get("15")) != -1) {
                                    ...
                                    if (map.get("20").toString() == "true") {
                                        ...
                                        console.log("adjustmentBatchQty Test@123", adjustmentBatchQty)
                                        console.log("adjustmentQty Test@123", adjustmentQty)
                                        if (adjustmentBatchQty < adjustmentQty) {
                                            ...
                                            console.log("Remaining Batch Qty Test@123", remainingBatchQty)
