                    ...
                    dataSourceRequest.onsuccess = function (event) {
                        ...
                        var options = {
                            ...
                            columns: [
                                ...
                                { title: adjustmentVisible ? i18n.t('static.supplyPlan.quantityQATProduct') : "", type: adjustmentColumnType, visible: adjustmentVisible, mask: (localStorage.getItem("roundingEnabled") != undefined && localStorage.getItem("roundingEnabled").toString() == "false") ? '[-]#,##.00' : '[-]#,##', decimal: '.', width: 120, readOnly: true, autoCasting: false },
                                { title: actualVisible ? i18n.t('static.supplyPlan.quantityQATProduct') : "", type: actualColumnType, visible: actualVisible, mask: (localStorage.getItem("roundingEnabled") != undefined && localStorage.getItem("roundingEnabled").toString() == "false") ? '#,##.00' : '#,##', decimal: '.', width: 120, readOnly: true, autoCasting: false },
