                    ...
                    for (var i = 0; createdDate < lastDataEntryDate; i++) {
                        ...
                        for (var b = 0; b < batchDetails.length; b++) {
                            ...
                            var jsonWps = {
                                ...
                                autoGenerated: batchDetails[b].autoGenerated,
                                openingBalance: batchDetails[b].qty,
                                openingBalanceWps: batchDetails.qtyWps,
                                consumption: 0,
                                adjustment: 0,
                                stock: 0,
                                shipment: 0,
                        ...
                        myArray = myArray.filter(c => c.openingBalance != 0 || c.consumption != 0 || c.shipment != 0 || c.stock != 0 || c.adjustment != 0);
                        console.log("Sorted array start date", startDate)
