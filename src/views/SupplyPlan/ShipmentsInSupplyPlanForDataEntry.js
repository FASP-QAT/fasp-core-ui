                                        ...
                                        currencyRequest.onsuccess = function (event) {
                                            ...
                                            var options = {
                                                ...
                                                columns: [
                                                    ...
                                                    { visible:false, title: "Is changed", readOnly: true },
                                                    { title: 'A',visible:false, width: 0, readOnly: true },
    ...
    IF(
            ...
            var options = {
                ...
                columns: [
                    ...
                    { title: 'A', visible:false, width: 0, readOnly: true },
                    { visible:false, readOnly: true, title: i18n.t('static.procurementAgentPlanningUnit.moq'), width: 0, readOnly: true },
                    { visible:false, title: 'A', width: 0, readOnly: true },
                    { visible:false, title: 'A', width: 0, readOnly: true },
                    { visible:false, title: 'A', width: 0, readOnly: true },
                    { visible:false, title: 'A', width: 0, readOnly: true },
                    { visible:false, title: 'A', width: 0, readOnly: true },
