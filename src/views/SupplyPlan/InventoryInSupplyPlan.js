                ...
                dataSourceRequest.onsuccess = function (event) {
                    ...
                    var options = {
                        ...
                        columns: [
                            ...
                            { visible:false, title: 'A', width: 50,readOnly:true },
                            { visible:false, title: 'A', width: 0,readOnly:true },
    ...
    batchDetailsClicked(obj, x, y, e, inventoryEditable) {
        ...
        var options = {
            ...
            columns: [
                ...
                { title: 'A', visible:false, source: [{ id: 1, name: i18n.t('static.consumption.actual') }, { id: 2, name: i18n.t('static.inventoryType.adjustment') }], readOnly: true },
