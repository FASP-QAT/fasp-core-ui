...
export default class InventoryInSupplyPlanComponent extends React.Component {
                ...
                dataSourceRequest.onsuccess = function (event) {
                    ...
                    var options = {
                        ...
                        columns: [
                            ...
                            { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: adjustmentColumnType, mask: '[-]#,##', disabledMaskOnEdition: true, width: 80 },
                            { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: actualColumnType, mask: '#,##.00', disabledMaskOnEdition: true, decimal: '.', width: 80 },
                                        ...
                                        onclick: function () {
                                            ...
                                            var options = {
                                                ...
                                                columns: [
                                                    ...
                                                    { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: adjustmentColumnType, disabledMaskOnEdition:true,mask: '[-]#,##', width: 80 },
                                                    { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: actualColumnType, mask: '#,##.00',disabledMaskOnEdition:true, decimal: '.', width: 80 },
    ...
    inventoryChanged = function (instance, cell, x, y, value) {
        ...
        if (x == 5) {
            if (rowData[4] == 2) {
                var valid = checkValidtion("number", "F", y, elInstance.getValue(`F${parseInt(y) + 1}`, true), elInstance, JEXCEL_NEGATIVE_INTEGER_NO_REGEX, 0, 0);
                if (valid == false) {
                    elInstance.setValueFromCoords(16, y, 1, true);
                } else {
                    if (elInstance.getValue(`F${parseInt(y) + 1}`, true).length > 10) {
                        ...
                        console.log("RowData5", elInstance.getValue(`F${parseInt(y) + 1}`, true));
                        console.log("(parseInt(rowData[5])) > 0", (parseInt(elInstance.getValue(`F${parseInt(y) + 1}`, true))) > 0);
                        if (batchDetails.length > 0 && (parseInt(adjustmentBatchQty) > 0 ? parseInt(adjustmentBatchQty) > parseInt(elInstance.getValue(`F${parseInt(y) + 1}`, true)) : parseInt(adjustmentBatchQty) < parseInt(elInstance.getValue(`F${parseInt(y) + 1}`, true)))) {
        ...
        if (x == 6) {
            if (rowData[4] == 1) {
                var valid = checkValidtion("number", "G", y, elInstance.getValue(`G${parseInt(y) + 1}`, true), elInstance, JEXCEL_INTEGER_REGEX, 1, 1);
                if (valid == false) {
                    elInstance.setValueFromCoords(16, y, 1, true);
                } else {
                    var batchDetails = rowData[13];
                    ...
                    if (batchDetails.length > 0 && parseInt(elInstance.getValue(`G${parseInt(y) + 1}`, true)) < parseInt(actualBatchQty)) {
    ...
    saveInventoryBatchInfo() {
        ...
        if (validation == true) {
            ...
            if (countForNonFefo == 0) {
                ...
                if (cf == true) {
                    if (map.get("2") == 1 && inventoryInstance.getValue(`G${parseInt(rowNumber) + 1}`, true) != "" && totalActualStock > inventoryInstance.getValue(`G${parseInt(rowNumber) + 1}`, true)) {
                        var cf1 = window.confirm(i18n.t("static.batchDetails.warningQunatity"))
                        if (cf1 == true) {
                        } else {
                            allConfirm = false;
                        }
                    } else if (map.get("2") == 2 && inventoryInstance.getValue(`F${parseInt(rowNumber) + 1}`, true) != "" && (totalAdjustments > 0 ? totalAdjustments > inventoryInstance.getValue(`F${parseInt(rowNumber) + 1}`, true) : totalAdjustments < inventoryInstance.getValue(`F${parseInt(rowNumber) + 1}`, true))) {
                        var cf1 = window.confirm(i18n.t("static.batchDetails.warningQunatity"))
                        if (cf1 == true) {
                        } else {
                            allConfirm = false;
            ...
            if (allConfirm == true) {
                if (map.get("2") == 1) {
                    ...
                    if (totalActualStock > inventoryInstance.getValue(`G${parseInt(rowNumber) + 1}`, true)) {
                    ...
                    if ((totalAdjustments > 0 ? totalAdjustments > inventoryInstance.getValue(`F${parseInt(rowNumber) + 1}`, true) : totalAdjustments < inventoryInstance.getValue(`F${parseInt(rowNumber) + 1}`, true))) {
    ...
    checkValidationInventory() {
        ...
        for (var y = 0; y < json.length; y++) {
            ...
            if (adjustmentType == 1 && (checkDuplicateInMap.length > 1 || (checkDuplicateOverAll.length > 0 && index != map.get("14")))) {
                ...
                if (rowData[4] == 2) {
                    var validation = checkValidtion("number", "F", y, elInstance.getValue(`F${parseInt(y) + 1}`, true), elInstance, JEXCEL_NEGATIVE_INTEGER_NO_REGEX, 0, 0);
                    if (validation == false) {
                        valid = false;
                        elInstance.setValueFromCoords(16, y, 1, true);
                    } else {
                ...
                if (rowData[4] == 1) {
                    var validation = checkValidtion("number", "G", y, elInstance.getValue(`G${parseInt(y) + 1}`, true), elInstance, JEXCEL_INTEGER_REGEX, 1, 1);
                    if (validation == false) {
                        valid = false;
                        elInstance.setValueFromCoords(16, y, 1, true);
                    }
