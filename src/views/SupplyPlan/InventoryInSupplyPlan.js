            ...
            realmRequest.onsuccess = function (event) {
                ...
                rcpuRequest.onsuccess = function (event) {
                    ...
                    dataSourceRequest.onsuccess = function (event) {
                        ...
                        if (AuthenticationService.checkUserACLBasedOnRoleId(programId.map(c=>c.toString()), 'ROLE_GUEST_USER') || this.props.items.programQPLDetails.filter(c => c.id == this.props.items.programId)[0].readonly) {
                            inventoryEditable = false;
                        }
