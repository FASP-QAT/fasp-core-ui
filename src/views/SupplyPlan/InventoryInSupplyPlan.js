        ...
        openRequest.onsuccess = function (e) {
            ...
            rcpuRequest.onsuccess = function (event) {
                ...
                dataSourceRequest.onsuccess = function (event) {
                    ...
                    var adjustmentColumnType = "true";
                    var adjustmentColumnTypeVisible = false;
                    if (adjustmentType == 2) {
                        adjustmentColumnType = "numeric"
                    }
                    // var actualColumnType = "hidden";
                    var actualColumnType = "true";
                    var actualColumnTypeVisible = false;
                    if (adjustmentType == 1) {
                    ...
                    var options = {
                        ...
                        columns: [
                            ...
                            { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: adjustmentColumnType,visible: 'false', mask: '[-]#,##', textEditor: true, disabledMaskOnEdition: true, width: 120 },
                            { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: actualColumnType,visible: 'false', mask: '#,##', textEditor: true, disabledMaskOnEdition: true, decimal: '.', width: 120 },
                            { title: i18n.t('static.unit.multiplierFromARUTOPU'), type: 'numeric', mask: '#,##0.0000', decimal: '.', width: 90, readOnly: true },
                            { title: i18n.t('static.supplyPlan.quantityQATProduct'), type: adjustmentColumnType,visible: 'false', mask: '[-]#,##.00', decimal: '.', width: 120, readOnly: true },
                            { title: i18n.t('static.supplyPlan.quantityQATProduct'), type: actualColumnType,visible: 'false', mask: '#,##.00', decimal: '.', width: 120, readOnly: true },
    ...
    batchDetailsClicked(obj, x, y, e, inventoryEditable) {
        ...
        var options = {
            ...
            columns: [
                ...
                { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: adjustmentColumnType, visible: 'false', mask: '[-]#,##', textEditor: true, disabledMaskOnEdition: true, width: 80 },
                { title: i18n.t('static.supplyPlan.quantityCountryProduct'), type: actualColumnType,visible: 'false', mask: '#,##', textEditor: true, disabledMaskOnEdition: true, width: 80 },
