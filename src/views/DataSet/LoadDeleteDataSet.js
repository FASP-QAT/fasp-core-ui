                                                                                ...
                                                                                <span className="tree_label">
                                                                                    <span className="">
                                                                                        <div className="checkbox m-0">
                                                                                            ...
                                                                                            {/* {this.state.programList.filter(c => c.programId == item2.program.id).length > 0 && <i title="Clean up" onClick={() => this.deleteLocalVersionUsingProgramId(item2.program.id)} className="fa fa-paint-brush ml-1 CleanUpIcon"></i>} */}
                                                                                        </div>
                                                                                    </span>
                                                                                </span>
