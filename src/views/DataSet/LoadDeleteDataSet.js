                        ...
                        <Card>
                            ...
                            <CardBody className="pb-lg-2 pt-lg-2">
                                <ul className="legendcommitversion pl-0" style={{ display: 'inline-flex' }}>
                                    ...
                                    <li><span><i title="Clean up" className="fa fa-paint-brush CleanUpIcon"></i></span> <span className="legendDeleteCleanupText">Keep latest  version and delete older versions.</span></li>
                                                                                ...
                                                                                <span className="tree_label">
                                                                                    <span className="">
                                                                                        <div className="checkbox m-0">
                                                                                            ...
                                                                                            {this.state.programList.filter(c => c.programId == item2.program.id).length > 0 && <i title="Clean up" onClick={() => this.deleteLocalVersionUsingProgramId(item2.program.id)} className="fa fa-paint-brush ml-1 CleanUpIconTree"></i>}
                                                                                        </div>
                                                                                    </span>
                                                                                </span>
