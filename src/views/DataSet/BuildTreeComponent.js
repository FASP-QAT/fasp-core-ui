                ...
                if (this.state.treeId != "") {
                    ...
                    for (var i = 0; i < items.length; i++) {
                        if(items[i].payload.downwardAggregationList && items[i].payload.downwardAggregationList.length > 0) {
                            ...
                            let newDownwardAggregationList = filteredDownwardAggregationList.map(c => ((c.treeId == this.state.treeId && c.scenarioId == this.state.selectedScenario) ? { ...c, targetScenarioId: scenarioId.toString(), scenarioId: scenarioId.toString() } : { ...c, targetScenarioId: scenarioId.toString() }));
                        ...
                        var tempArray = [];
                        var nodeDataMap = {};
                        tempArray.push(JSON.parse(JSON.stringify((items[i].payload.nodeDataMap[this.state.selectedScenario])[0])));
                                        ...
                                        <>
                                            ...
                                            <div className="row">
                                                ...
                                                {this.state.currentItemConfig.context.payload.downwardAggregationAllowed && <div className="col-md-6">
                                                    ...
                                                    {this.state.sourceNodeUsageList.map(sn => (<><u><a href={"/#/dataSet/buildTree/tree/" + sn.treeId + "/" + this.state.programId + "/" + sn.scenarioId} target="_blank">
                                            ...
                                            {(this.state.currentItemConfig.context.payload.nodeType.id == 5) &&
                                                <>
                                                    <div className="row pl-lg-3 pr-lg-3">
                                                        ...
                                                        <FormGroup className="col-md-4">
                                                            <Label htmlFor="currencyId">{i18n.t('static.tree.nodeTitle')}<span class="red Reqasterisk">*</span> <i class="fa fa-info-circle icons pl-lg-2" id="Popover3_5" onClick={this.toggleNodeTitle} aria-hidden="true" style={{ color: '#002f6c', cursor: 'pointer' }}></i></Label>
                                                            <Input type="text"
                                                                id="nodeTitle"
                                                                name="nodeTitle"
                                                                bsSize="sm"
                                                        ...
                                                        <div>
                                                            <Popover placement="top" isOpen={this.state.popoverOpenNodeType} target="Popover4_5" trigger="hover" toggle={this.toggleNodeType}>
                                                                <PopoverBody>{i18n.t('static.tooltip.NodeType')}</PopoverBody>
                                                            </Popover>
                                                        </div>
                                                        <Input
                                                        ...
                                                        />
                                                        <FormGroup className={"col-md-4"}>
                                                            <Label htmlFor="currencyId">{i18n.t('static.tree.nodeType')}<span class="red Reqasterisk">*</span> <i class="fa fa-info-circle icons pl-lg-2" id="Popover4_5" onClick={this.toggleNodeType} aria-hidden="true" style={{ color: '#002f6c', cursor: 'pointer' }}></i></Label>
                                                            <Input
                                                                type="select"
                                                                id="nodeTypeId"
                                                                name="nodeTypeId"
                                                        ...
                                                        <div>
                                                            <Popover placement="top" isOpen={this.state.popoverOpenParentValue} target="Popover6_5" trigger="hover" toggle={this.toggleParentValue}>
                                                                <PopoverBody>{i18n.t('static.tooltip.ParentValue')}</PopoverBody>
                                                            </Popover>
                                                        </div>
                                                        <FormGroup className="col-md-4" style={{ display: this.state.numberNode ? 'block' : 'none' }}>
                                                            <Label htmlFor="currencyId">{i18n.t('static.tree.parentValue')} in {moment(this.state.currentScenario.month).format(`MMM-YYYY`)} <i class="fa fa-info-circle icons pl-lg-2" id="Popover6_5" onClick={this.toggleParentValue} aria-hidden="true" style={{ color: '#002f6c', cursor: 'pointer' }}></i></Label>
                                                            <Input type="text"
                                                                id="parentValue"
                                                                name="parentValue"
                                                                bsSize="sm"
                                                        ...
                                                        <div>
                                                            <Popover placement="top" isOpen={this.state.popoverOpenPercentageOfParent} target="Popover5_5" trigger="hover" toggle={this.togglePercentageOfParent}>
                                                                 <PopoverBody>{i18n.t('static.tooltip.PercentageOfParent')}</PopoverBody>
                                                            </Popover>
                                                        </div>
                                                        <FormGroup className="col-md-4 PUNodemarginTop" style={{ display: this.state.numberNode ? 'block' : 'none' }}>
                                                            <Label htmlFor="currencyId">{i18n.t('static.tree.percentageOfParent')}<span class="red Reqasterisk">*</span> <i class="fa fa-info-circle icons pl-lg-2" id="Popover5_5" onClick={this.togglePercentageOfParent} aria-hidden="true" style={{ color: '#002f6c', cursor: 'pointer' }}></i></Label>
                                                            <InputGroup>
                                                                <Input type="number"
                                                                    id="percentageOfParent"
                                                                    name="percentageOfParent"
                                                        ...
                                                        <div>
                                                            <Popover placement="top" isOpen={this.state.popoverOpenNodeValue} target="Popover7_5" trigger="hover" toggle={this.toggleNodeValue}>
                                                                <PopoverBody>{this.state.numberNode ? i18n.t('static.tooltip.NodeValue') : i18n.t('static.tooltip.NumberNodeValue')}</PopoverBody>
                                                            </Popover>
                                                        </div>
                                                        <FormGroup className="col-md-4 PUNodemarginTop" style={{ display: this.state.aggregationNode ? 'block' : 'none' }}>
                                                            <Label htmlFor="currencyId">{i18n.t('static.tree.nodeValue')}{this.state.numberNode}<span class="red Reqasterisk">*</span> <i class="fa fa-info-circle icons pl-lg-2" id="Popover7_5" onClick={this.toggleNodeValue} aria-hidden="true" style={{ color: '#002f6c', cursor: 'pointer' }}></i></Label>
                                                            <Input type="text"
                                                                id="nodeValue"
                                                                name="nodeValue"
                                                                bsSize="sm"
                                                ...
                                                <>
                                                    ...
                                                    {(this.state.parentScenario.fuNode.usageType.id == 1 || this.state.parentScenario.fuNode.usageType.id == 2) &&
                                                        <>
                                                            ...
                                                            <FormGroup className="col-md-6">
                                                                <Label htmlFor="currencyId"># PU / {this.state.parentScenario.fuNode.usageType.id == 2 ? "Month / " : ""}{this.state.currentItemConfig.parentItem != null && this.state.currentItemConfig.parentItem.parent != null && this.state.unitList.filter(c => c.unitId == this.state.items.filter(x => x.id == this.state.currentItemConfig.parentItem.parent)[0].payload.nodeUnit.id).length > 0 && this.state.unitList.filter(c => c.unitId == this.state.items.filter(x => x.id == this.state.currentItemConfig.parentItem.parent)[0].payload.nodeUnit.id)[0].label.label_en}(s) (Calculated)</Label>
                                                                <Input type="text"
                                                                    id="puPerVisitQATCalculated"
                                                                    name="puPerVisitQATCalculated"
                                                                    readOnly={true}
                                                            ...
                                                            {this.state.parentScenario.fuNode != null && (this.state.currentScenario.puNode.sharePlanningUnit == "false" || this.state.currentScenario.puNode.sharePlanningUnit == false) &&
                                                                <FormGroup className="col-md-6">
                                                                    <Label htmlFor="currencyId">{this.state.currentItemConfig.parentItem != null && this.state.parentScenario.fuNode != null && this.state.parentScenario.fuNode.usageType.id == 2 ? "# PU / Month / " : "# PU / "}{this.state.currentItemConfig.parentItem != null && this.state.currentItemConfig.parentItem.parent != null && this.state.unitList.filter(c => c.unitId == this.state.items.filter(x => x.id == this.state.currentItemConfig.parentItem.parent)[0].payload.nodeUnit.id).length > 0 && this.state.unitList.filter(c => c.unitId == this.state.items.filter(x => x.id == this.state.currentItemConfig.parentItem.parent)[0].payload.nodeUnit.id)[0].label.label_en}(s)</Label>
                                                                    <Input type="text"
                                                                        id="puPerVisit"
                                                                        name="puPerVisit"
        ...
        for (var i = 0; i < newItems.length; i++) {
            if (newItems[i].payload.nodeType.id == 6) {
                if (!newItems[i].payload.downwardAggregationList || newItems[i].payload.downwardAggregationList.length == 0) {
                    ...
                    for (var j = 0; j < newItems[i].payload.downwardAggregationList.length; j++) {
                        if (newItems[i].payload.downwardAggregationList[j].treeId == this.state.treeId && (newItems[i].payload.downwardAggregationList[j].targetScenarioId == this.state.selectedScenario && newItems[i].payload.downwardAggregationList[j].scenarioId == this.state.selectedScenario) && this.state.showConnections) {
                            treeLevelItems.push(new ConnectorAnnotationConfig({
                                annotationType: AnnotationType.Connector,
                                fromItem: parseInt(newItems[i].payload.downwardAggregationList[j].nodeId),
                                toItem: parseInt(newItems[i].id),
