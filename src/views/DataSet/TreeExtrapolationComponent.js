...
export default class TreeExtrapolationComponent extends React.Component {
    constructor(props) {
        ...
        var startDate1 = moment(this.props.items.forecastStartDate).startOf('month').subtract(24, 'months').startOf('month').format("YYYY-MM-DD");
        var endDate1 = moment(this.props.items.forecastStartDate).startOf('month').format("YYYY-MM-DD");
        this.state = {
