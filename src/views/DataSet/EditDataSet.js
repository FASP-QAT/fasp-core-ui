        ...
        ProgramService.getDatasetById(this.props.match.params.dataSetId).then(response => {
            ...
            ProgramService.getHealthAreaListByRealmCountryId(response.data.realmCountry.realmCountryId)
                .then(response => {
                    if (response.status == 200) {
                        var haList = [];
                        if (AuthenticationService.checkUserACL(this.props.match.params.dataSetId.map(c.toString()), "ROLE_BF_UPDATE_TA_FOR_FP")) {
                            var json = response.data;
                            for (var i = 0; i < json.length; i++) {
                                            ...
                                            <CardBody>
                                                ...
                                                <FormGroup>
                                                    ...
                                                    <Select
                                                        ...
                                                        disabled={!AuthenticationService.checkUserACL(this.props.match.params.dataSetId.map(c.toString()), "ROLE_BF_UPDATE_TA_FOR_FP") ? true : false}
                                                        name="healthAreaId"
                                                        id="healthAreaId"
                                                    />
                                                ...
                                                <FormGroup>
                                                    ...
                                                    <Input
                                                        ...
                                                        name="organisationId"
                                                        id="organisationId"
                                                        disabled={!AuthenticationService.checkUserACL(this.props.match.params.dataSetId.map(c.toString()), "ROLE_BF_UPDATE_ORG_FOR_FP") ? true : false}
                                                    ...
                                                    <Col xs="5" className="pr-0">
                                                        <FormGroup className="pt-2">
                                                            ...
                                                            <Input
                                                                ...
                                                                disabled={!AuthenticationService.checkUserACL(this.props.match.params.dataSetId.map(c.toString()), "ROLE_BF_UPDATE_PC_FOR_FP") ? true : false}
