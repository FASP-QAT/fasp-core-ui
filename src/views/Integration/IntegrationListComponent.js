            ...
            <div className="animated">
                ...
                <Card style={{ display: this.state.loading ? "none" : "block" }}>
                    ...
                    <CardBody className="table-responsive pt-md-1 pb-md-1">
                        ...
                        <div id="tableDiv" className={AuthenticationService.getLoggedInUserRoleBusinessFunctionArray().includes('ROLE_BF_EDIT_INTEGRATION') ? "jexcelremoveReadonlybackground RowClickable" : "jexcelremoveReadonlybackground"}></div>
                    </CardBody>
                </Card>
