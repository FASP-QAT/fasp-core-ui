            ...
            <div className="animated">
                ...
                <Card>
                    ...
                    <CardBody>
                        <Col md="3">
                            <FormGroup>
                                <Label htmlFor="appendedInputButton">{i18n.t('static.procurementagent.realmname')}</Label>
                        ...
                        <BootstrapTable data={this.state.selProcurementAgent} version="4" hover pagination search options={this.options}>
                            ...
                            <TableHeaderColumn filterFormatted dataField="realm" dataFormat={this.showRealmLabel} dataAlign="center" dataSort>{i18n.t('static.procurementagent.realmname')}</TableHeaderColumn>
