        ...
        if (cont == true) {
            ...
            if (puList.length > 0) {
                ...
                if (document.getElementById("addRowButtonId") != null) {
                    ...
                    if (AuthenticationService.checkUserACLBasedOnRoleId(programId.toString.split("_")[0].map(c.toString()), 'ROLE_GUEST_USER') || this.state.programQPLDetails.filter(c => c.id == this.state.programId)[0].readonly) {
                        document.getElementById("addRowButtonId").style.display = "none";
                    }
                }
                var db1;
