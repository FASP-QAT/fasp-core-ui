...
export default class ManualTagging extends Component {
    ...
    filterData = (planningUnitIds) => {
        ...
        // Code in use
        var planningUnitSelect = "";
        // = document.getElementById("planningUnitId");
        var planningUnitName = "";
        // = planningUnitSelect.options[planningUnitSelect.selectedIndex].text;
    ...
    buildJExcelERP(){
        ...
        for (var j = 0; j < erpDataList.length; j++) {
            ...
            data[2] = erpDataList[j].roNo;
            data[3] = erpDataList[j].roPrimeLineNo;
            data[4] = erpDataList[j].orderNo;
            data[5] = erpDataList[j].primeLineNo;
            data[6] = this.formatDate(erpDataList[j].currentEstimatedDeliveryDate);;
            data[7] = erpDataList[j].status
            data[8] = this.addCommas(erpDataList[j].quantity);
...
console.log("data-----------------",data)
        var options = {
            ...
            columns: [
                ...
                {
                    title: i18n.t('static.manualTagging.ROPrimeline'),
                    type: 'text',
                },
                {
                    title:i18n.t('static.manualTagging.erpShipmentNo'),
                    type: 'text',
                },
                {
                    title: i18n.t('static.manualTagging.erpShipmentLineNo'),
                    type: 'text',
                }
                ,
                {
        ...
        var languageEl = jexcel(document.getElementById("tableDiv1"), options);
        this.el = languageEl;
        this.setState({
            languageEl: languageEl, loading: false
        })
