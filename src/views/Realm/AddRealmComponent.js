                                            ...
                                            <Form onSubmit={handleSubmit} onReset={handleReset} noValidate name='realmForm'>
                                                ...
                                                <CardFooter>
                                                    <FormGroup>
                                                        ...
                                                        <Button type="reset" color="success" size="md" className="float-right mr-1 text-white" onClick={this.resetClicked}><i className="fa fa-refresh"></i> {i18n.t('static.common.reset')}</Button>
