                            ...
                            <Col md="12 pl-0 pt-3">
                              <div className="d-md-flex">
                                ...
                                <FormGroup className="tab-ml-1 mt-4">
                                  ...
                                  {((this.state.isChanged.toString() == "true" && this.state.versionType == 1) || (this.state.versionType == 2 && (this.state.openCount == 0 || AuthenticationService.checkUserACL([this.state.programId.programId.toString()],"ROLE_BF_READONLY_ACCESS_REALM_ADMIN")))) && this.state.conflictsCount == 0 && <Button type="submit" size="md" color="success" className="float-right mr-1" ><i className="fa fa-check"></i>{i18n.t('static.button.commit')} </Button>}
                                  &nbsp;
                                </FormGroup>
                              </div>
                            </Col>
