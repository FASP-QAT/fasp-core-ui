  ...
  showConsumptionData(oldData, latestData, index) {
    ...
    var options = {
      ...
      columns: [
        ...
        { title: i18n.t('static.supplyPlan.quantityQATProduct'), type: 'numeric', mask: (localStorage.getItem("roundingEnabled") != undefined && localStorage.getItem("roundingEnabled").toString() == "false")?'#,##.00':'#,##',decimal:'.', width: 80 },
  ...
  showInventoryData(oldData, latestData, index) {
    ...
    var options = {
      ...
      columns: [
        ...
        { title: i18n.t('static.unit.multiplier'), type: 'numeric', mask: '#,##.000000', decimal: '.', width: 80, },
        { title: i18n.t('static.inventory.adjustmentQunatityPU'), type: 'numeric', mask: (localStorage.getItem("roundingEnabled") != undefined && localStorage.getItem("roundingEnabled").toString() == "false")?'[-]#,##.00':'[-]#,##',decimal:'.', width: 120, },
        { title: i18n.t('static.inventory.inventoryQunatityPU'), type: 'numeric', mask: (localStorage.getItem("roundingEnabled") != undefined && localStorage.getItem("roundingEnabled").toString() == "false")?'#,##.00':'#,##',decimal:'.', width: 120, },
        { title: i18n.t('static.program.notes'), type: 'text', width: 200 },
        { title: i18n.t('static.inventory.active'), type: 'checkbox', width: 70 },
        { type: 'hidden', title: i18n.t('static.supplyPlan.batchInfo'), width: 0 },
  ...
  showShipmentData(oldData, latestData, index) {
    ...
    var options = {
      ...
      columns: [
        ...
        { title: i18n.t('static.shipment.shipmentQtyPU'), type: 'numeric', mask: (localStorage.getItem("roundingEnabled") != undefined && localStorage.getItem("roundingEnabled").toString() == "false")?'#,##.00':'#,##',decimal:'.', width: 120 },
