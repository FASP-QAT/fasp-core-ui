    ...
    componentDidMount() {
        ...
        for (var j = 0; j < planningUnitSet.length; j++) {
            for (var k = 0; k < regionSet.length; k++) {
                ...
                data[2]=getLabelText(puFiltered[0].selectedForecast)
                data[3]=puFiltered[0].totalForecast!==""  && puFiltered[0].totalForecast!=null?Number(puFiltered[0].totalForecast).toFixed(2):"";
                data[4]=(puFiltered[0].notes != null && puFiltered[0].notes!='' ? puFiltered[0].notes.label_en : '')
                data[5]=getLabelText(puFiltered1[0].selectedForecast)
                data[6]=puFiltered1[0].totalForecast!=="" && puFiltered1[0].totalForecast!=null?Number(puFiltered1[0].totalForecast).toFixed(2):"";
                data[7]=(puFiltered1[0].notes != null && puFiltered[0].notes!='' ? puFiltered1[0].notes.label_en : '')
                data[8]=""
                data[9]=""
                data[10]=""
                dataArray.push(data);
