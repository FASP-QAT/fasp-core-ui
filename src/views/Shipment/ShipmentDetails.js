...
export default class ShipmentDetails extends React.Component {
    ...
    exportCSV() {
        ...
        worksheet.columns = [
            ...
            { header: i18n.t('static.dataentry.autogeneratedFreight'), key: 'string', width: 25 },
        ...
        worksheet.dataValidations.add('Y2:Y1000', {
            type: 'list',
            allowBlank: false,
        ...
        worksheet.getColumn('Z').eachCell({ includeEmpty: true }, function (cell, rowNumber) {
            cell.protection = { locked: false };
        });
                ...
                <Modal isOpen={this.state.batchInfo}
                    ...
                    <ModalFooter>
                        <div id="showShipmentBatchInfoButtonsDiv" style={{ display: 'none' }} className="mr-0">
                            ...
                            <b><h3 className="float-right mr-2 text-blackD">{i18n.t("static.supplyPlan.shipmentQty") + " : " + this.addCommas(this.state.shipmentQtyTotalForPopup) + " / " + i18n.t("static.supplyPlan.batchQty") + " : " + this.addCommas(this.state.batchQtyTotalForPopup)}</h3></b>
                        </div>
