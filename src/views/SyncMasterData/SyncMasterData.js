                                ...
                                MasterSyncService.syncProgram(programList[i].programId, programList[i].version, programList[i].userId, date)
                                    .then(response => {
                                        ...
                                        if (response.status == 200) {
                                            ...
                                            var pplModified = programPlanningUnitList.filter(c => moment(c.lastModifiedDate).format("YYYY-MM-DD HH:mm:ss") >= moment(generalJson.currentVersion.createdDate).format("YYYY-MM-DD HH:mm:ss") && c.program.id == response.data.programId);
                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                    this.setState({
                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                        treeTemplateTransaction.oncomplete = function (event) {
                                                                                                                                                                                                                                                                                                                                                                                                                                            this.setState({
                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                // // branchTemplate
                                                                                                                                                                                                                                                                                                                                                                                                                                                // var branchTemplateTransaction = db1.transaction(['branchTemplate'], 'readwrite');
                                                                                                                                                                                                                                                                                                                                                                                                                                                // var branchTemplateObjectStore = branchTemplateTransaction.objectStore('branchTemplate');
                                                                                                                                                                                                                                                                                                                                                                                                                                                // var json = (response.branchTemplateList);
                                                                                                                                                                                                                                                                                                                                                                                                                                                // for (var i = 0; i < json.length; i++) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                //     branchTemplateObjectStore.put(json[i]);
                                                                                                                                                                                                                                                                                                                                                                                                                                                // }
                                                                                                                                                                                                                                                                                                                                                                                                                                                // branchTemplateTransaction.oncomplete = function (event) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                //     this.setState({
                                                                                                                                                                                                                                                                                                                                                                                                                                                //         syncedMasters: this.state.syncedMasters + 1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                //         syncedPercentage: Math.floor(((this.state.syncedMasters + 1) / this.state.totalMasters) * 100)
                                                                                                                                                                                                                                                                                                                                                                                                                                                //     }, () => {
