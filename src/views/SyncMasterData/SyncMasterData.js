...
export default class SyncMasterData extends Component {
    ...
    syncProgramData(date, programList, programQPLDetailsList, readonlyProgramIds) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    this.setState({
                                                                                                                                                                                        ...
                                                                                                                                                                                        budgetTransaction.oncomplete = function (event) {
                                                                                                                                                                                            this.setState({
                                                                                                                                                                                                ...
                                                                                                                                                                                                this.syncProgramData(lastSyncDate, myResult, programQPLDetailsJson, readonlyProgramIds);
                                                                                                                                                                                                // currency
