                      ...
                      <Col xs="12" md="12">
                        <Nav tabs className="marginTopTabs" style={{flexDirection: "row",borderBottom:"none"}} >
                          <NavItem className="bgColourRemoveItem itemWhidth">
                            ...
                            >
                              <i className="nav-icon fa fa-line-chart module1IconColour"  style={{ fontSize: '18px', paddingTop: '5px',color: '#20a8d8' }}></i><br></br>
                              <b>FORECASTING</b>
                            </NavLink>
                          </NavItem>
                          <NavItem className="bgColourRemoveItem itemWhidth">
                            ...
                            >
                              ...
                              <i className="nav-icon module2IconColour"><img src={imgforcastmoduletab} style={{ width: '25px', height: '25px',paddingTop: '0px',color: '#009471'}} /></i><br></br>
                              <b>S. PLANNING</b>
                            </NavLink>
                          </NavItem>
                        </Nav>
