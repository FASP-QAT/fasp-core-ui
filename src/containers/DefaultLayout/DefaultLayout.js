...
const routes = [
  ...
  { path: '/forecastMethod/editForecastMethod/:forecastMethodId', name: 'static.breadcrum.edit', entityname: 'static.forecastMethod.forecastMethod', component: EditForecastMethod },

  { path: '/usagePeriod/addUsagePeriod', name: 'static.breadcrum.add', entityname: 'static.usagePeriod.usagePeriod', component: AddUsagePeriod },
  ...
  { path: '/usagePeriod/editUsagePeriod/:usagePeriodId', name: 'static.breadcrum.edit', entityname: 'static.usagePeriod.usagePeriod', component: EditUsagePeriod },

  { path: '/scaleUpType/addscaleUpType', name: 'static.breadcrum.add', entityname: 'static.scaleUpType.scaleUpType', component: AddScaleUpType },
  { path: '/scaleUpType/listscaleUpType/:color/:message', name: 'static.breadcrum.list', entityname: 'static.scaleUpType.scaleUpType', component: ScaleUpTypeList },
                  ...
                  items:
                    [
                      ...
                      // !this.state.businessFunctions.includes('ROLE_BF_VIEW_GUEST_SCREENS') &&
                      {
                        ...
                        icon: 'fa fa-tree',
                        url: '/myTree',
                        attributes: { hidden: ((this.state.businessFunctions.includes('ROLE_BF_LABEL_TRANSLATIONS1')) ? false : true) },
                      },
                      {
                        name: "DragNDrop Tree.",
                        icon: 'fa fa-tree',
