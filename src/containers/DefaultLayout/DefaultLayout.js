...
const routes = [
  ...
  { path: '/dataSet/treeTable/', exact: true, name: 'static.common.managetree', component: TreeTable },
  { path: '/dataSet/treeTable/tree/:treeId/:programId', exact: true, name: 'static.common.managetree', component: TreeTable },
