...
export default class DemographicScenarioThree extends Component {
    constructor() {
        super();
        ...
        this.state = {
            ...
            cursorItem: 0,
            highlightItem: 0,
            items: TreeData.demographic_scenario_three,
            currentItemConfig: {}
        }
    }
    resetTree() {
        this.setState({ items: TreeData.demographic_scenario_three });
    }
    dataChange(event) {
        // alert("hi");
