...
const NodeDragDropSourceTwo = DropTarget(
    ItemTypes.NODE,
    {
...
export default class MorbidityScenarioTwo extends Component {
    constructor() {
        super();
        ...
        this.state = {
            ...
            cursorItem: 0,
            highlightItem: 0,
            items: TreeData.morbidity_scenario_two,
            currentItemConfig: {}
        }
    }
    resetTree() {
        this.setState({ items: TreeData.morbidity_scenario_two });
    }
    dataChange(event) {
        // alert("hi");
