...
class Sample extends Component {
  constructor(props) {
    ...
    this.state = {
      items: [
        { id: 10, relativeItem: 2, placementType: AdviserPlacementType.Left, position: 1, title: "Roger Dalton", label: "Roger Dalton", description: "Id: 10", image: "/react/photos/a.png", itemTitleColor: "#4169e1" },
        { id: 2, title: "Steven Lacombe", label: "Steven Lacombe", description: "Id: 2", image: "/react/photos/b.png", itemTitleColor: "#4b0082" },
        { id: 11, relativeItem: 2, placementType: AdviserPlacementType.Right, position: 1, title: "Bill Dalton", label: "Bill Dalton", description: "Id: 11", image: "/react/photos/c.png", itemTitleColor: "#4b0082" },
