                                                                    ...
                                                                    if (filteredShipmentList.length > 0) {
                                                                        ...
                                                                        for (var fsl = 0; fsl < problemActionListForShipments.length; fsl++) {
                                                                            ...
                                                                            if (!shipmentIdsFromShipmnetList.includes(fslShipmentId)) {
                                                                                ...
                                                                                incomplianceProblem(notIncludedShipmentIndex, username, userId, problemActionList);
                                                                            }
                                                                        }
                                                                        //new for loop logic=======================================
                                                                    } else {
                                                                        ...
                                                                        for (var d = 0; d < problemActionListForShipmentsIncompliance.length; d++) {
                                                                            ...
                                                                            incomplianceProblem(notIncludedShipmentIndexIncompliance, username, userId, problemActionList);
                                                                        }
                                                                        //new for loop logic=======================================
                                                                    }
                                                                    break;
