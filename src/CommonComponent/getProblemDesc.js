...
export default function getProblemDesc(row, lang) {
    ...
    if (row.realmProblem.problem.problemId == 30) {
        ...
        if (obj.overMaxMonthsCount > 0) {
            ...
            var monthNames = formatMonthRanges(obj.overMaxMonths.split(",")).toString().replaceAll(",",", ");
        ...
        if (obj.underMinMonthsCount > 0) {
            ...
            var monthNames = formatMonthRanges(obj.underMinMonths.split(",")).toString().replaceAll(",",", ");
        ...
        if (obj.stockedOutMonthsCount > 0) {
            ...
            var monthNames = formatMonthRanges(obj.stockedOutMonths.split(",")).toString().replaceAll(",",", ")
            desc += i18n.t('static.problemList.minMaxProblemDescStockedOut', { count, monthNames });
        }
        if (obj.shipmentListMonthsCount > 0) {
            var monthNames = formatMonthRanges(obj.shipmentListMonths.split(",")).toString().replaceAll(",",", ");
